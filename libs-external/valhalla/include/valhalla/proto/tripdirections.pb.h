...
inline const ::valhalla::odin::BoundingBox& TripDirections_Summary::bbox() const {
  return bbox_ != NULL ? *bbox_ : *default_instance_->bbox_;
}
inline ::valhalla::odin::BoundingBox* TripDirections_Summary::mutable_bbox() {
  set_has_bbox();
  if (bbox_ == NULL) bbox_ = new ::valhalla::odin::BoundingBox;
  return bbox_;
}
inline ::valhalla::odin::BoundingBox* TripDirections_Summary::release_bbox() {
  clear_has_bbox();
  ::valhalla::odin::BoundingBox* temp = bbox_;
  bbox_ = NULL;
  return temp;
}
inline void TripDirections_Summary::set_allocated_bbox(::valhalla::odin::BoundingBox* bbox) {
  delete bbox_;
  bbox_ = bbox;
  if (bbox) {
    set_has_bbox();
...
inline const ::valhalla::odin::LatLng& TripDirections_TransitStop::ll() const {
  return ll_ != NULL ? *ll_ : *default_instance_->ll_;
}
inline ::valhalla::odin::LatLng* TripDirections_TransitStop::mutable_ll() {
  set_has_ll();
  if (ll_ == NULL) ll_ = new ::valhalla::odin::LatLng;
  return ll_;
}
inline ::valhalla::odin::LatLng* TripDirections_TransitStop::release_ll() {
  clear_has_ll();
  ::valhalla::odin::LatLng* temp = ll_;
  ll_ = NULL;
  return temp;
}
inline void TripDirections_TransitStop::set_allocated_ll(::valhalla::odin::LatLng* ll) {
  delete ll_;
  ll_ = ll;
  if (ll) {
    set_has_ll();
...
inline const ::valhalla::odin::Location& TripDirections::location(int index) const {
  return location_.Get(index);
}
inline ::valhalla::odin::Location* TripDirections::mutable_location(int index) {
  return location_.Mutable(index);
}
inline ::valhalla::odin::Location* TripDirections::add_location() {
