...
Maneuver::Maneuver()
  ...
  street_names_ = std::unique_ptr<StreetNames>(new StreetNames);
  begin_street_names_ = std::unique_ptr<StreetNames>(new StreetNames);
  cross_street_names_ = std::unique_ptr<StreetNames>(new StreetNames);
}
...
void Maneuver::set_street_names(const std::vector<std::string>& names) {
  street_names_ = std::unique_ptr<StreetNamesUs>(new StreetNamesUs(names));
}
...
void Maneuver::set_begin_street_names(const std::vector<std::string>& names) {
  begin_street_names_ = std::unique_ptr<StreetNamesUs>(new StreetNamesUs(names));
}
...
void Maneuver::set_cross_street_names(const std::vector<std::string>& names) {
  cross_street_names_ = std::unique_ptr<StreetNamesUs>(new StreetNamesUs(names));
}
