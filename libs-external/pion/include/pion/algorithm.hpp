...
struct PION_API algorithm {
    ...
    static inline std::uint32_t to_uint32(unsigned char high, unsigned char mid1, unsigned char mid2, unsigned char low) {
        return (((std::uint32_t)high) << 24) | (((std::uint32_t)mid1) << 16) | (((std::uint32_t)mid2) << 8) | ((std::uint32_t)low);
    }
    ...
    static inline std::uint64_t to_uint64(unsigned char high, unsigned char mid1, unsigned char mid2, unsigned char mid3, unsigned char mid4, unsigned char mid5, unsigned char mid6, unsigned char low) {
        return (((std::uint64_t)high) << 56) | (((std::uint64_t)mid1) << 48) | (((std::uint64_t)mid2) << 40) | (((std::uint64_t)mid3) << 32)
            | (((std::uint64_t)mid4) << 24) | (((std::uint64_t)mid5) << 16) | (((std::uint64_t)mid6) << 8) | ((std::uint64_t)low);
    }
    ...
    /// convert sequence of three bytes to 24-bit unsigned integer
    template <typename Byte>
    static inline std::uint32_t to_uint24(const Byte *buf) {
    ...
    template <typename Byte>
    static inline void from_uint24(Byte *buf, const std::uint32_t n) {
        buf[0] = (n >> 16) & 0xFF;
        buf[1] = (n >> 8) & 0xFF;
        buf[2] = n & 0xFF;
    }
