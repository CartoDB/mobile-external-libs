...
inline std::string* CostingOptions::release_transport_type() {
  ...
  _has_bits_[0] &= ~0x00000001u;
  return transport_type_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
...
inline std::string* Options::release_language() {
  ...
  _has_bits_[0] &= ~0x00000001u;
  return language_.ReleaseNonDefault(nullptr, GetArenaForAllocation());
}
...
inline std::string* Options::release_jsonp() {
  ...
  _has_bits_[0] &= ~0x00000004u;
  return jsonp_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
...
inline std::string* Options::release_encoded_polyline() {
  ...
  _has_bits_[0] &= ~0x00000008u;
  return encoded_polyline_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
