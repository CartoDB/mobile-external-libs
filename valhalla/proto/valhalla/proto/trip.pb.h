...
class TripLeg_BikeShareStationInfo;
struct TripLeg_BikeShareStationInfoDefaultTypeInternal;
extern TripLeg_BikeShareStationInfoDefaultTypeInternal _TripLeg_BikeShareStationInfo_default_instance_;
...
extern TripLeg_SignDefaultTypeInternal _TripLeg_Sign_default_instance_;
class TripLeg_SignElement;
struct TripLeg_SignElementDefaultTypeInternal;
extern TripLeg_SignElementDefaultTypeInternal _TripLeg_SignElement_default_instance_;
...
extern TripLeg_TransitRouteInfoDefaultTypeInternal _TripLeg_TransitRouteInfo_default_instance_;
class TripRoute;
...
template<> ::valhalla::TripLeg_BikeShareStationInfo* Arena::CreateMaybeMessage<::valhalla::TripLeg_BikeShareStationInfo>(Arena*);
...
template<> ::valhalla::TripLeg_Sign* Arena::CreateMaybeMessage<::valhalla::TripLeg_Sign>(Arena*);
template<> ::valhalla::TripLeg_SignElement* Arena::CreateMaybeMessage<::valhalla::TripLeg_SignElement>(Arena*);
template<> ::valhalla::TripLeg_TrafficSegment* Arena::CreateMaybeMessage<::valhalla::TripLeg_TrafficSegment>(Arena*);
template<> ::valhalla::TripLeg_TransitRouteInfo* Arena::CreateMaybeMessage<::valhalla::TripLeg_TransitRouteInfo>(Arena*);
...
constexpr TripLeg_TravelMode TripLeg_TravelMode_TravelMode_MIN = TripLeg_TravelMode_kDrive;
constexpr TripLeg_TravelMode TripLeg_TravelMode_TravelMode_MAX = TripLeg_TravelMode_kTransit;
constexpr int TripLeg_TravelMode_TravelMode_ARRAYSIZE = TripLeg_TravelMode_TravelMode_MAX + 1;

const std::string& TripLeg_TravelMode_Name(TripLeg_TravelMode value);
template<typename T>
inline const std::string& TripLeg_TravelMode_Name(T enum_t_value) {
  static_assert(::std::is_same<T, TripLeg_TravelMode>::value ||
    ::std::is_integral<T>::value,
    "Incorrect type passed to function TripLeg_TravelMode_Name.");
  return TripLeg_TravelMode_Name(static_cast<TripLeg_TravelMode>(enum_t_value));
}
bool TripLeg_TravelMode_Parse(
    ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, TripLeg_TravelMode* value);
enum TripLeg_VehicleType : int {
...
constexpr TripLeg_VehicleType TripLeg_VehicleType_VehicleType_MIN = TripLeg_VehicleType_kCar;
constexpr TripLeg_VehicleType TripLeg_VehicleType_VehicleType_MAX = TripLeg_VehicleType_kMotorScooter;
constexpr int TripLeg_VehicleType_VehicleType_ARRAYSIZE = TripLeg_VehicleType_VehicleType_MAX + 1;

const std::string& TripLeg_VehicleType_Name(TripLeg_VehicleType value);
template<typename T>
inline const std::string& TripLeg_VehicleType_Name(T enum_t_value) {
  static_assert(::std::is_same<T, TripLeg_VehicleType>::value ||
    ::std::is_integral<T>::value,
    "Incorrect type passed to function TripLeg_VehicleType_Name.");
  return TripLeg_VehicleType_Name(static_cast<TripLeg_VehicleType>(enum_t_value));
}
bool TripLeg_VehicleType_Parse(
    ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, TripLeg_VehicleType* value);
enum TripLeg_PedestrianType : int {
...
constexpr TripLeg_PedestrianType TripLeg_PedestrianType_PedestrianType_MIN = TripLeg_PedestrianType_kFoot;
constexpr TripLeg_PedestrianType TripLeg_PedestrianType_PedestrianType_MAX = TripLeg_PedestrianType_kSegway;
constexpr int TripLeg_PedestrianType_PedestrianType_ARRAYSIZE = TripLeg_PedestrianType_PedestrianType_MAX + 1;

const std::string& TripLeg_PedestrianType_Name(TripLeg_PedestrianType value);
template<typename T>
inline const std::string& TripLeg_PedestrianType_Name(T enum_t_value) {
  static_assert(::std::is_same<T, TripLeg_PedestrianType>::value ||
    ::std::is_integral<T>::value,
    "Incorrect type passed to function TripLeg_PedestrianType_Name.");
  return TripLeg_PedestrianType_Name(static_cast<TripLeg_PedestrianType>(enum_t_value));
}
bool TripLeg_PedestrianType_Parse(
    ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, TripLeg_PedestrianType* value);
enum TripLeg_BicycleType : int {
...
constexpr TripLeg_BicycleType TripLeg_BicycleType_BicycleType_MIN = TripLeg_BicycleType_kRoad;
constexpr TripLeg_BicycleType TripLeg_BicycleType_BicycleType_MAX = TripLeg_BicycleType_kMountain;
constexpr int TripLeg_BicycleType_BicycleType_ARRAYSIZE = TripLeg_BicycleType_BicycleType_MAX + 1;

const std::string& TripLeg_BicycleType_Name(TripLeg_BicycleType value);
template<typename T>
inline const std::string& TripLeg_BicycleType_Name(T enum_t_value) {
  static_assert(::std::is_same<T, TripLeg_BicycleType>::value ||
    ::std::is_integral<T>::value,
    "Incorrect type passed to function TripLeg_BicycleType_Name.");
  return TripLeg_BicycleType_Name(static_cast<TripLeg_BicycleType>(enum_t_value));
}
bool TripLeg_BicycleType_Parse(
    ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, TripLeg_BicycleType* value);
enum TripLeg_TransitType : int {
...
constexpr TripLeg_TransitType TripLeg_TransitType_TransitType_MIN = TripLeg_TransitType_kTram;
constexpr TripLeg_TransitType TripLeg_TransitType_TransitType_MAX = TripLeg_TransitType_kFunicular;
constexpr int TripLeg_TransitType_TransitType_ARRAYSIZE = TripLeg_TransitType_TransitType_MAX + 1;

const std::string& TripLeg_TransitType_Name(TripLeg_TransitType value);
template<typename T>
inline const std::string& TripLeg_TransitType_Name(T enum_t_value) {
  static_assert(::std::is_same<T, TripLeg_TransitType>::value ||
    ::std::is_integral<T>::value,
    "Incorrect type passed to function TripLeg_TransitType_Name.");
  return TripLeg_TransitType_Name(static_cast<TripLeg_TransitType>(enum_t_value));
}
...
class TripLeg_SignElement PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::MessageLite /* @@protoc_insertion_point(class_definition:valhalla.TripLeg.SignElement) */ {
 public:
  inline TripLeg_SignElement() : TripLeg_SignElement(nullptr) {}
  virtual ~TripLeg_SignElement();
  explicit constexpr TripLeg_SignElement(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  TripLeg_SignElement(const TripLeg_SignElement& from);
  TripLeg_SignElement(TripLeg_SignElement&& from) noexcept
    : TripLeg_SignElement() {
    *this = ::std::move(from);
  }
  ...
  inline TripLeg_SignElement& operator=(TripLeg_SignElement&& from) noexcept {
  ...
  static inline const TripLeg_SignElement* internal_default_instance() {
    return reinterpret_cast<const TripLeg_SignElement*>(
               &_TripLeg_SignElement_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    0;

  friend void swap(TripLeg_SignElement& a, TripLeg_SignElement& b) {
    a.Swap(&b);
  }
  inline void Swap(TripLeg_SignElement* other) {
  ...
  void UnsafeArenaSwap(TripLeg_SignElement* other) {
    if (other == this) return;
  ...
  inline TripLeg_SignElement* New() const final {
    return CreateMaybeMessage<TripLeg_SignElement>(nullptr);
  }

  TripLeg_SignElement* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<TripLeg_SignElement>(arena);
  }
  ...
  void InternalSwap(TripLeg_SignElement* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "valhalla.TripLeg.SignElement";
  }
  protected:
  explicit TripLeg_SignElement(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
...
class TripLeg_Sign PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::MessageLite /* @@protoc_insertion_point(class_definition:valhalla.TripLeg.Sign) */ {
 public:
  inline TripLeg_Sign() : TripLeg_Sign(nullptr) {}
  virtual ~TripLeg_Sign();
  explicit constexpr TripLeg_Sign(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  TripLeg_Sign(const TripLeg_Sign& from);
  TripLeg_Sign(TripLeg_Sign&& from) noexcept
    : TripLeg_Sign() {
    *this = ::std::move(from);
  }
  ...
  inline TripLeg_Sign& operator=(TripLeg_Sign&& from) noexcept {
    if (GetArena() == from.GetArena()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  static inline const TripLeg_Sign* internal_default_instance() {
    return reinterpret_cast<const TripLeg_Sign*>(
               &_TripLeg_Sign_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    1;

  friend void swap(TripLeg_Sign& a, TripLeg_Sign& b) {
    a.Swap(&b);
  }
  inline void Swap(TripLeg_Sign* other) {
    if (other == this) return;
    if (GetArena() == other->GetArena()) {
      InternalSwap(other);
    } else {
  ...
  void UnsafeArenaSwap(TripLeg_Sign* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetArena() == other->GetArena());
    InternalSwap(other);
  }
  ...
  inline TripLeg_Sign* New() const final {
    return CreateMaybeMessage<TripLeg_Sign>(nullptr);
  }

  TripLeg_Sign* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<TripLeg_Sign>(arena);
  }
  void CheckTypeAndMergeFrom(const ::PROTOBUF_NAMESPACE_ID::MessageLite& from)
    final;
  ...
  inline void SharedDtor();
  void SetCachedSize(int size) const;
  void InternalSwap(TripLeg_Sign* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "valhalla.TripLeg.Sign";
  }
  protected:
  explicit TripLeg_Sign(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  public:
  ...
  ::valhalla::TripLeg_SignElement* mutable_exit_numbers(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::valhalla::TripLeg_SignElement >*
      mutable_exit_numbers();
  private:
  const ::valhalla::TripLeg_SignElement& _internal_exit_numbers(int index) const;
  ::valhalla::TripLeg_SignElement* _internal_add_exit_numbers();
  public:
  const ::valhalla::TripLeg_SignElement& exit_numbers(int index) const;
  ::valhalla::TripLeg_SignElement* add_exit_numbers();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::valhalla::TripLeg_SignElement >&
      exit_numbers() const;
  ...
  ::valhalla::TripLeg_SignElement* mutable_exit_onto_streets(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::valhalla::TripLeg_SignElement >*
      mutable_exit_onto_streets();
  private:
  const ::valhalla::TripLeg_SignElement& _internal_exit_onto_streets(int index) const;
  ::valhalla::TripLeg_SignElement* _internal_add_exit_onto_streets();
  public:
  const ::valhalla::TripLeg_SignElement& exit_onto_streets(int index) const;
  ::valhalla::TripLeg_SignElement* add_exit_onto_streets();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::valhalla::TripLeg_SignElement >&
  ...
  ::valhalla::TripLeg_SignElement* mutable_exit_toward_locations(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::valhalla::TripLeg_SignElement >*
      mutable_exit_toward_locations();
  private:
  const ::valhalla::TripLeg_SignElement& _internal_exit_toward_locations(int index) const;
  ::valhalla::TripLeg_SignElement* _internal_add_exit_toward_locations();
  public:
  const ::valhalla::TripLeg_SignElement& exit_toward_locations(int index) const;
  ::valhalla::TripLeg_SignElement* add_exit_toward_locations();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::valhalla::TripLeg_SignElement >&
  ...
  ::valhalla::TripLeg_SignElement* mutable_exit_names(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::valhalla::TripLeg_SignElement >*
      mutable_exit_names();
  private:
  const ::valhalla::TripLeg_SignElement& _internal_exit_names(int index) const;
  ::valhalla::TripLeg_SignElement* _internal_add_exit_names();
  public:
  const ::valhalla::TripLeg_SignElement& exit_names(int index) const;
  ::valhalla::TripLeg_SignElement* add_exit_names();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::valhalla::TripLeg_SignElement >&
      exit_names() const;
  ...
  ::valhalla::TripLeg_SignElement* mutable_guide_onto_streets(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::valhalla::TripLeg_SignElement >*
      mutable_guide_onto_streets();
  private:
  const ::valhalla::TripLeg_SignElement& _internal_guide_onto_streets(int index) const;
  ::valhalla::TripLeg_SignElement* _internal_add_guide_onto_streets();
  public:
  const ::valhalla::TripLeg_SignElement& guide_onto_streets(int index) const;
  ::valhalla::TripLeg_SignElement* add_guide_onto_streets();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::valhalla::TripLeg_SignElement >&
  ...
  ::valhalla::TripLeg_SignElement* mutable_guide_toward_locations(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::valhalla::TripLeg_SignElement >*
      mutable_guide_toward_locations();
  private:
  const ::valhalla::TripLeg_SignElement& _internal_guide_toward_locations(int index) const;
  ::valhalla::TripLeg_SignElement* _internal_add_guide_toward_locations();
  public:
  const ::valhalla::TripLeg_SignElement& guide_toward_locations(int index) const;
  ::valhalla::TripLeg_SignElement* add_guide_toward_locations();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::valhalla::TripLeg_SignElement >&
  ...
  ::valhalla::TripLeg_SignElement* mutable_junction_names(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::valhalla::TripLeg_SignElement >*
      mutable_junction_names();
  private:
  const ::valhalla::TripLeg_SignElement& _internal_junction_names(int index) const;
  ::valhalla::TripLeg_SignElement* _internal_add_junction_names();
  public:
  const ::valhalla::TripLeg_SignElement& junction_names(int index) const;
  ::valhalla::TripLeg_SignElement* add_junction_names();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::valhalla::TripLeg_SignElement >&
  ...
  ::valhalla::TripLeg_SignElement* mutable_guidance_view_junctions(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::valhalla::TripLeg_SignElement >*
      mutable_guidance_view_junctions();
  private:
  const ::valhalla::TripLeg_SignElement& _internal_guidance_view_junctions(int index) const;
  ::valhalla::TripLeg_SignElement* _internal_add_guidance_view_junctions();
  public:
  const ::valhalla::TripLeg_SignElement& guidance_view_junctions(int index) const;
  ::valhalla::TripLeg_SignElement* add_guidance_view_junctions();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::valhalla::TripLeg_SignElement >&
  ...
  ::valhalla::TripLeg_SignElement* mutable_guidance_view_signboards(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::valhalla::TripLeg_SignElement >*
      mutable_guidance_view_signboards();
  private:
  const ::valhalla::TripLeg_SignElement& _internal_guidance_view_signboards(int index) const;
  ::valhalla::TripLeg_SignElement* _internal_add_guidance_view_signboards();
  public:
  const ::valhalla::TripLeg_SignElement& guidance_view_signboards(int index) const;
  ::valhalla::TripLeg_SignElement* add_guidance_view_signboards();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::valhalla::TripLeg_SignElement >&
 ...
 private:
  ...
  typedef void InternalArenaConstructable_;
  typedef void DestructorSkippable_;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::valhalla::TripLeg_SignElement > exit_numbers_;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::valhalla::TripLeg_SignElement > exit_onto_streets_;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::valhalla::TripLeg_SignElement > exit_toward_locations_;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::valhalla::TripLeg_SignElement > exit_names_;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::valhalla::TripLeg_SignElement > guide_onto_streets_;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::valhalla::TripLeg_SignElement > guide_toward_locations_;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::valhalla::TripLeg_SignElement > junction_names_;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::valhalla::TripLeg_SignElement > guidance_view_junctions_;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::valhalla::TripLeg_SignElement > guidance_view_signboards_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_trip_2eproto;
};
// -------------------------------------------------------------------

class TripLeg_TransitRouteInfo PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::MessageLite /* @@protoc_insertion_point(class_definition:valhalla.TripLeg.TransitRouteInfo) */ {
 public:
  inline TripLeg_TransitRouteInfo() : TripLeg_TransitRouteInfo(nullptr) {}
  virtual ~TripLeg_TransitRouteInfo();
  explicit constexpr TripLeg_TransitRouteInfo(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  TripLeg_TransitRouteInfo(const TripLeg_TransitRouteInfo& from);
  TripLeg_TransitRouteInfo(TripLeg_TransitRouteInfo&& from) noexcept
  ...
  inline TripLeg_TransitRouteInfo& operator=(TripLeg_TransitRouteInfo&& from) noexcept {
    if (GetArena() == from.GetArena()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  static inline const TripLeg_TransitRouteInfo* internal_default_instance() {
    return reinterpret_cast<const TripLeg_TransitRouteInfo*>(
               &_TripLeg_TransitRouteInfo_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    2;

  friend void swap(TripLeg_TransitRouteInfo& a, TripLeg_TransitRouteInfo& b) {
    a.Swap(&b);
  }
  inline void Swap(TripLeg_TransitRouteInfo* other) {
    if (other == this) return;
    if (GetArena() == other->GetArena()) {
      InternalSwap(other);
    } else {
  ...
  void UnsafeArenaSwap(TripLeg_TransitRouteInfo* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetArena() == other->GetArena());
    InternalSwap(other);
  }
  ...
  inline TripLeg_TransitRouteInfo* New() const final {
    return CreateMaybeMessage<TripLeg_TransitRouteInfo>(nullptr);
  }

  TripLeg_TransitRouteInfo* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<TripLeg_TransitRouteInfo>(arena);
  }
  void CheckTypeAndMergeFrom(const ::PROTOBUF_NAMESPACE_ID::MessageLite& from)
    final;
  ...
  inline void SharedDtor();
  void SetCachedSize(int size) const;
  void InternalSwap(TripLeg_TransitRouteInfo* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "valhalla.TripLeg.TransitRouteInfo";
  }
  protected:
  explicit TripLeg_TransitRouteInfo(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  public:
...
class TripLeg_BikeShareStationInfo PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::MessageLite /* @@protoc_insertion_point(class_definition:valhalla.TripLeg.BikeShareStationInfo) */ {
 public:
  inline TripLeg_BikeShareStationInfo() : TripLeg_BikeShareStationInfo(nullptr) {}
  virtual ~TripLeg_BikeShareStationInfo();
  explicit constexpr TripLeg_BikeShareStationInfo(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  TripLeg_BikeShareStationInfo(const TripLeg_BikeShareStationInfo& from);
  TripLeg_BikeShareStationInfo(TripLeg_BikeShareStationInfo&& from) noexcept
    : TripLeg_BikeShareStationInfo() {
    *this = ::std::move(from);
  }

  inline TripLeg_BikeShareStationInfo& operator=(const TripLeg_BikeShareStationInfo& from) {
    CopyFrom(from);
    return *this;
  }
  inline TripLeg_BikeShareStationInfo& operator=(TripLeg_BikeShareStationInfo&& from) noexcept {
    if (GetArena() == from.GetArena()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  static const TripLeg_BikeShareStationInfo& default_instance() {
    return *internal_default_instance();
  }
  static inline const TripLeg_BikeShareStationInfo* internal_default_instance() {
    return reinterpret_cast<const TripLeg_BikeShareStationInfo*>(
               &_TripLeg_BikeShareStationInfo_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    3;

  friend void swap(TripLeg_BikeShareStationInfo& a, TripLeg_BikeShareStationInfo& b) {
    a.Swap(&b);
  }
  inline void Swap(TripLeg_BikeShareStationInfo* other) {
    if (other == this) return;
    if (GetArena() == other->GetArena()) {
      InternalSwap(other);
    } else {
  ...
  void UnsafeArenaSwap(TripLeg_BikeShareStationInfo* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetArena() == other->GetArena());
    InternalSwap(other);
  }
  ...
  inline TripLeg_BikeShareStationInfo* New() const final {
    return CreateMaybeMessage<TripLeg_BikeShareStationInfo>(nullptr);
  }

  TripLeg_BikeShareStationInfo* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<TripLeg_BikeShareStationInfo>(arena);
  }
  void CheckTypeAndMergeFrom(const ::PROTOBUF_NAMESPACE_ID::MessageLite& from)
    final;
  void CopyFrom(const TripLeg_BikeShareStationInfo& from);
  void MergeFrom(const TripLeg_BikeShareStationInfo& from);
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  bool IsInitialized() const final;
  ...
  inline void SharedDtor();
  void SetCachedSize(int size) const;
  void InternalSwap(TripLeg_BikeShareStationInfo* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "valhalla.TripLeg.BikeShareStationInfo";
  }
  protected:
  explicit TripLeg_BikeShareStationInfo(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  public:
  ...
  void _internal_set_capacity(const std::string& value);
  ...
  // @@protoc_insertion_point(class_scope:valhalla.TripLeg.BikeShareStationInfo)
 private:
  class _Internal;
...
class TripLeg_Edge PROTOBUF_FINAL :
 ...
 public:
  ...
  int tagged_name_size() const;
  private:
  int _internal_tagged_name_size() const;
  public:
  void clear_tagged_name();
  ::valhalla::TaggedName* mutable_tagged_name(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::valhalla::TaggedName >*
      mutable_tagged_name();
  private:
  const ::valhalla::TaggedName& _internal_tagged_name(int index) const;
  ::valhalla::TaggedName* _internal_add_tagged_name();
  public:
  const ::valhalla::TaggedName& tagged_name(int index) const;
  ::valhalla::TaggedName* add_tagged_name();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::valhalla::TaggedName >&
      tagged_name() const;
  ...
  ::valhalla::TripLeg_Sign* release_sign();
  ::valhalla::TripLeg_Sign* mutable_sign();
  void set_allocated_sign(::valhalla::TripLeg_Sign* sign);
  private:
  const ::valhalla::TripLeg_Sign& _internal_sign() const;
  ::valhalla::TripLeg_Sign* _internal_mutable_sign();
  public:
  void unsafe_arena_set_allocated_sign(
      ::valhalla::TripLeg_Sign* sign);
  ::valhalla::TripLeg_Sign* unsafe_arena_release_sign();
  ...
  ::valhalla::TripLeg_TransitRouteInfo* release_transit_route_info();
  ::valhalla::TripLeg_TransitRouteInfo* mutable_transit_route_info();
  void set_allocated_transit_route_info(::valhalla::TripLeg_TransitRouteInfo* transit_route_info);
  private:
  const ::valhalla::TripLeg_TransitRouteInfo& _internal_transit_route_info() const;
  ::valhalla::TripLeg_TransitRouteInfo* _internal_mutable_transit_route_info();
  public:
  void unsafe_arena_set_allocated_transit_route_info(
      ::valhalla::TripLeg_TransitRouteInfo* transit_route_info);
  ::valhalla::TripLeg_TransitRouteInfo* unsafe_arena_release_transit_route_info();
  ...
  void set_travel_mode(::valhalla::TripLeg_TravelMode value);
  private:
  ::valhalla::TripLeg_TravelMode _internal_travel_mode() const;
  void _internal_set_travel_mode(::valhalla::TripLeg_TravelMode value);
  public:
  ...
  void set_vehicle_type(::valhalla::TripLeg_VehicleType value);
  private:
  ::valhalla::TripLeg_VehicleType _internal_vehicle_type() const;
  void _internal_set_vehicle_type(::valhalla::TripLeg_VehicleType value);
  public:
  ...
  void set_pedestrian_type(::valhalla::TripLeg_PedestrianType value);
  private:
  ::valhalla::TripLeg_PedestrianType _internal_pedestrian_type() const;
  void _internal_set_pedestrian_type(::valhalla::TripLeg_PedestrianType value);
  public:
  ...
  void set_bicycle_type(::valhalla::TripLeg_BicycleType value);
  private:
  ::valhalla::TripLeg_BicycleType _internal_bicycle_type() const;
  void _internal_set_bicycle_type(::valhalla::TripLeg_BicycleType value);
  public:
  ...
  void set_transit_type(::valhalla::TripLeg_TransitType value);
  private:
  ::valhalla::TripLeg_TransitType _internal_transit_type() const;
  void _internal_set_transit_type(::valhalla::TripLeg_TransitType value);
  public:
  ...
  bool has_drive_on_right() const;
  private:
  bool _internal_has_drive_on_right() const;
  public:
  void clear_drive_on_right();
  bool drive_on_right() const;
  void set_drive_on_right(bool value);
  private:
  bool _internal_drive_on_right() const;
  void _internal_set_drive_on_right(bool value);
  public:
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::valhalla::TaggedName > tagged_name_;
...
class TripLeg_Node PROTOBUF_FINAL :
 ...
 public:
  ...
  public:
  void clear_bss_info();
  const ::valhalla::TripLeg_BikeShareStationInfo& bss_info() const;
  ::valhalla::TripLeg_BikeShareStationInfo* release_bss_info();
  ::valhalla::TripLeg_BikeShareStationInfo* mutable_bss_info();
  void set_allocated_bss_info(::valhalla::TripLeg_BikeShareStationInfo* bss_info);
  private:
  const ::valhalla::TripLeg_BikeShareStationInfo& _internal_bss_info() const;
  ::valhalla::TripLeg_BikeShareStationInfo* _internal_mutable_bss_info();
  public:
  void unsafe_arena_set_allocated_bss_info(
      ::valhalla::TripLeg_BikeShareStationInfo* bss_info);
  ::valhalla::TripLeg_BikeShareStationInfo* unsafe_arena_release_bss_info();
 ...
 private:
  ...
  ::valhalla::TripLeg_BikeShareStationInfo* bss_info_;
...
class TripLeg PROTOBUF_FINAL :
 ...
 public:
  ...
  typedef TripLeg_BikeShareStationInfo BikeShareStationInfo;
  ...
  static constexpr TravelMode kPedestrian =
    TripLeg_TravelMode_kPedestrian;
  static constexpr TravelMode kBicycle =
    TripLeg_TravelMode_kBicycle;
  static constexpr TravelMode kTransit =
    TripLeg_TravelMode_kTransit;
  ...
  static inline const std::string& TransitType_Name(T enum_t_value) {
    ...
    return TripLeg_TransitType_Name(enum_t_value);
  }
  static inline bool TransitType_Parse(::PROTOBUF_NAMESPACE_ID::ConstStringParam name,
      TransitType* value) {
    return TripLeg_TransitType_Parse(name, value);
  }
...
// optional string text = 1;
inline bool TripLeg_SignElement::_internal_has_text() const {
...
inline const std::string& TripLeg_SignElement::text() const {
  // @@protoc_insertion_point(field_get:valhalla.TripLeg.SignElement.text)
  return _internal_text();
}
inline void TripLeg_SignElement::set_text(const std::string& value) {
  _internal_set_text(value);
  // @@protoc_insertion_point(field_set:valhalla.TripLeg.SignElement.text)
}
inline std::string* TripLeg_SignElement::mutable_text() {
  // @@protoc_insertion_point(field_mutable:valhalla.TripLeg.SignElement.text)
  return _internal_mutable_text();
}
inline const std::string& TripLeg_SignElement::_internal_text() const {
  return text_.Get();
}
inline void TripLeg_SignElement::_internal_set_text(const std::string& value) {
  _has_bits_[0] |= 0x00000001u;
  text_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
inline void TripLeg_SignElement::set_text(std::string&& value) {
  _has_bits_[0] |= 0x00000001u;
  text_.Set(
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:valhalla.TripLeg.SignElement.text)
}
inline void TripLeg_SignElement::set_text(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:valhalla.TripLeg.SignElement.text)
}
inline void TripLeg_SignElement::set_text(const char* value,
    size_t size) {
  _has_bits_[0] |= 0x00000001u;
  ...
  // @@protoc_insertion_point(field_set_pointer:valhalla.TripLeg.SignElement.text)
}
inline std::string* TripLeg_SignElement::_internal_mutable_text() {
  _has_bits_[0] |= 0x00000001u;
...
inline std::string* TripLeg_SignElement::release_text() {
  // @@protoc_insertion_point(field_release:valhalla.TripLeg.SignElement.text)
...
inline void TripLeg_SignElement::set_allocated_text(std::string* text) {
  ...
  text_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), text,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:valhalla.TripLeg.SignElement.text)
}

// optional bool is_route_number = 2;
inline bool TripLeg_SignElement::_internal_has_is_route_number() const {
...
inline bool TripLeg_SignElement::_internal_is_route_number() const {
  return is_route_number_;
}
inline bool TripLeg_SignElement::is_route_number() const {
  // @@protoc_insertion_point(field_get:valhalla.TripLeg.SignElement.is_route_number)
  return _internal_is_route_number();
}
inline void TripLeg_SignElement::_internal_set_is_route_number(bool value) {
  _has_bits_[0] |= 0x00000002u;
  is_route_number_ = value;
}
inline void TripLeg_SignElement::set_is_route_number(bool value) {
  _internal_set_is_route_number(value);
  // @@protoc_insertion_point(field_set:valhalla.TripLeg.SignElement.is_route_number)
}
...
// repeated .valhalla.TripLeg.SignElement exit_numbers = 1;
inline int TripLeg_Sign::_internal_exit_numbers_size() const {
...
inline ::valhalla::TripLeg_SignElement* TripLeg_Sign::mutable_exit_numbers(int index) {
  // @@protoc_insertion_point(field_mutable:valhalla.TripLeg.Sign.exit_numbers)
  return exit_numbers_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::valhalla::TripLeg_SignElement >*
TripLeg_Sign::mutable_exit_numbers() {
  // @@protoc_insertion_point(field_mutable_list:valhalla.TripLeg.Sign.exit_numbers)
  return &exit_numbers_;
}
inline const ::valhalla::TripLeg_SignElement& TripLeg_Sign::_internal_exit_numbers(int index) const {
  return exit_numbers_.Get(index);
}
inline const ::valhalla::TripLeg_SignElement& TripLeg_Sign::exit_numbers(int index) const {
  // @@protoc_insertion_point(field_get:valhalla.TripLeg.Sign.exit_numbers)
  return _internal_exit_numbers(index);
}
inline ::valhalla::TripLeg_SignElement* TripLeg_Sign::_internal_add_exit_numbers() {
  return exit_numbers_.Add();
}
inline ::valhalla::TripLeg_SignElement* TripLeg_Sign::add_exit_numbers() {
  // @@protoc_insertion_point(field_add:valhalla.TripLeg.Sign.exit_numbers)
  return _internal_add_exit_numbers();
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::valhalla::TripLeg_SignElement >&
TripLeg_Sign::exit_numbers() const {
  // @@protoc_insertion_point(field_list:valhalla.TripLeg.Sign.exit_numbers)
  return exit_numbers_;
}

// repeated .valhalla.TripLeg.SignElement exit_onto_streets = 2;
inline int TripLeg_Sign::_internal_exit_onto_streets_size() const {
...
inline ::valhalla::TripLeg_SignElement* TripLeg_Sign::mutable_exit_onto_streets(int index) {
  // @@protoc_insertion_point(field_mutable:valhalla.TripLeg.Sign.exit_onto_streets)
  return exit_onto_streets_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::valhalla::TripLeg_SignElement >*
TripLeg_Sign::mutable_exit_onto_streets() {
  // @@protoc_insertion_point(field_mutable_list:valhalla.TripLeg.Sign.exit_onto_streets)
  return &exit_onto_streets_;
}
inline const ::valhalla::TripLeg_SignElement& TripLeg_Sign::_internal_exit_onto_streets(int index) const {
...
inline const ::valhalla::TripLeg_SignElement& TripLeg_Sign::exit_onto_streets(int index) const {
  // @@protoc_insertion_point(field_get:valhalla.TripLeg.Sign.exit_onto_streets)
  return _internal_exit_onto_streets(index);
}
inline ::valhalla::TripLeg_SignElement* TripLeg_Sign::_internal_add_exit_onto_streets() {
  return exit_onto_streets_.Add();
}
inline ::valhalla::TripLeg_SignElement* TripLeg_Sign::add_exit_onto_streets() {
  // @@protoc_insertion_point(field_add:valhalla.TripLeg.Sign.exit_onto_streets)
  return _internal_add_exit_onto_streets();
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::valhalla::TripLeg_SignElement >&
TripLeg_Sign::exit_onto_streets() const {
  // @@protoc_insertion_point(field_list:valhalla.TripLeg.Sign.exit_onto_streets)
  return exit_onto_streets_;
}

// repeated .valhalla.TripLeg.SignElement exit_toward_locations = 3;
inline int TripLeg_Sign::_internal_exit_toward_locations_size() const {
...
inline ::valhalla::TripLeg_SignElement* TripLeg_Sign::mutable_exit_toward_locations(int index) {
  // @@protoc_insertion_point(field_mutable:valhalla.TripLeg.Sign.exit_toward_locations)
  return exit_toward_locations_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::valhalla::TripLeg_SignElement >*
TripLeg_Sign::mutable_exit_toward_locations() {
  // @@protoc_insertion_point(field_mutable_list:valhalla.TripLeg.Sign.exit_toward_locations)
  return &exit_toward_locations_;
}
inline const ::valhalla::TripLeg_SignElement& TripLeg_Sign::_internal_exit_toward_locations(int index) const {
...
inline const ::valhalla::TripLeg_SignElement& TripLeg_Sign::exit_toward_locations(int index) const {
  // @@protoc_insertion_point(field_get:valhalla.TripLeg.Sign.exit_toward_locations)
  return _internal_exit_toward_locations(index);
}
inline ::valhalla::TripLeg_SignElement* TripLeg_Sign::_internal_add_exit_toward_locations() {
  return exit_toward_locations_.Add();
}
inline ::valhalla::TripLeg_SignElement* TripLeg_Sign::add_exit_toward_locations() {
  // @@protoc_insertion_point(field_add:valhalla.TripLeg.Sign.exit_toward_locations)
  return _internal_add_exit_toward_locations();
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::valhalla::TripLeg_SignElement >&
TripLeg_Sign::exit_toward_locations() const {
  // @@protoc_insertion_point(field_list:valhalla.TripLeg.Sign.exit_toward_locations)
  return exit_toward_locations_;
}

// repeated .valhalla.TripLeg.SignElement exit_names = 4;
inline int TripLeg_Sign::_internal_exit_names_size() const {
...
inline ::valhalla::TripLeg_SignElement* TripLeg_Sign::mutable_exit_names(int index) {
  // @@protoc_insertion_point(field_mutable:valhalla.TripLeg.Sign.exit_names)
  return exit_names_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::valhalla::TripLeg_SignElement >*
TripLeg_Sign::mutable_exit_names() {
  // @@protoc_insertion_point(field_mutable_list:valhalla.TripLeg.Sign.exit_names)
  return &exit_names_;
}
inline const ::valhalla::TripLeg_SignElement& TripLeg_Sign::_internal_exit_names(int index) const {
  return exit_names_.Get(index);
}
inline const ::valhalla::TripLeg_SignElement& TripLeg_Sign::exit_names(int index) const {
  // @@protoc_insertion_point(field_get:valhalla.TripLeg.Sign.exit_names)
  return _internal_exit_names(index);
}
inline ::valhalla::TripLeg_SignElement* TripLeg_Sign::_internal_add_exit_names() {
  return exit_names_.Add();
}
inline ::valhalla::TripLeg_SignElement* TripLeg_Sign::add_exit_names() {
  // @@protoc_insertion_point(field_add:valhalla.TripLeg.Sign.exit_names)
  return _internal_add_exit_names();
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::valhalla::TripLeg_SignElement >&
TripLeg_Sign::exit_names() const {
  // @@protoc_insertion_point(field_list:valhalla.TripLeg.Sign.exit_names)
  return exit_names_;
}

// repeated .valhalla.TripLeg.SignElement guide_onto_streets = 5;
inline int TripLeg_Sign::_internal_guide_onto_streets_size() const {
  return guide_onto_streets_.size();
}
inline int TripLeg_Sign::guide_onto_streets_size() const {
  return _internal_guide_onto_streets_size();
}
inline void TripLeg_Sign::clear_guide_onto_streets() {
  guide_onto_streets_.Clear();
}
inline ::valhalla::TripLeg_SignElement* TripLeg_Sign::mutable_guide_onto_streets(int index) {
  // @@protoc_insertion_point(field_mutable:valhalla.TripLeg.Sign.guide_onto_streets)
  return guide_onto_streets_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::valhalla::TripLeg_SignElement >*
TripLeg_Sign::mutable_guide_onto_streets() {
  // @@protoc_insertion_point(field_mutable_list:valhalla.TripLeg.Sign.guide_onto_streets)
  return &guide_onto_streets_;
}
inline const ::valhalla::TripLeg_SignElement& TripLeg_Sign::_internal_guide_onto_streets(int index) const {
  return guide_onto_streets_.Get(index);
}
inline const ::valhalla::TripLeg_SignElement& TripLeg_Sign::guide_onto_streets(int index) const {
  // @@protoc_insertion_point(field_get:valhalla.TripLeg.Sign.guide_onto_streets)
  return _internal_guide_onto_streets(index);
}
inline ::valhalla::TripLeg_SignElement* TripLeg_Sign::_internal_add_guide_onto_streets() {
  return guide_onto_streets_.Add();
}
inline ::valhalla::TripLeg_SignElement* TripLeg_Sign::add_guide_onto_streets() {
  // @@protoc_insertion_point(field_add:valhalla.TripLeg.Sign.guide_onto_streets)
  return _internal_add_guide_onto_streets();
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::valhalla::TripLeg_SignElement >&
TripLeg_Sign::guide_onto_streets() const {
  // @@protoc_insertion_point(field_list:valhalla.TripLeg.Sign.guide_onto_streets)
  return guide_onto_streets_;
}

// repeated .valhalla.TripLeg.SignElement guide_toward_locations = 6;
inline int TripLeg_Sign::_internal_guide_toward_locations_size() const {
  return guide_toward_locations_.size();
}
inline int TripLeg_Sign::guide_toward_locations_size() const {
  return _internal_guide_toward_locations_size();
}
inline void TripLeg_Sign::clear_guide_toward_locations() {
  guide_toward_locations_.Clear();
}
inline ::valhalla::TripLeg_SignElement* TripLeg_Sign::mutable_guide_toward_locations(int index) {
  // @@protoc_insertion_point(field_mutable:valhalla.TripLeg.Sign.guide_toward_locations)
  return guide_toward_locations_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::valhalla::TripLeg_SignElement >*
TripLeg_Sign::mutable_guide_toward_locations() {
  // @@protoc_insertion_point(field_mutable_list:valhalla.TripLeg.Sign.guide_toward_locations)
  return &guide_toward_locations_;
}
inline const ::valhalla::TripLeg_SignElement& TripLeg_Sign::_internal_guide_toward_locations(int index) const {
  return guide_toward_locations_.Get(index);
}
inline const ::valhalla::TripLeg_SignElement& TripLeg_Sign::guide_toward_locations(int index) const {
  // @@protoc_insertion_point(field_get:valhalla.TripLeg.Sign.guide_toward_locations)
  return _internal_guide_toward_locations(index);
}
inline ::valhalla::TripLeg_SignElement* TripLeg_Sign::_internal_add_guide_toward_locations() {
  return guide_toward_locations_.Add();
}
inline ::valhalla::TripLeg_SignElement* TripLeg_Sign::add_guide_toward_locations() {
  // @@protoc_insertion_point(field_add:valhalla.TripLeg.Sign.guide_toward_locations)
  return _internal_add_guide_toward_locations();
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::valhalla::TripLeg_SignElement >&
TripLeg_Sign::guide_toward_locations() const {
  // @@protoc_insertion_point(field_list:valhalla.TripLeg.Sign.guide_toward_locations)
  return guide_toward_locations_;
}

// repeated .valhalla.TripLeg.SignElement junction_names = 7;
inline int TripLeg_Sign::_internal_junction_names_size() const {
  return junction_names_.size();
}
inline int TripLeg_Sign::junction_names_size() const {
  return _internal_junction_names_size();
}
inline void TripLeg_Sign::clear_junction_names() {
  junction_names_.Clear();
}
inline ::valhalla::TripLeg_SignElement* TripLeg_Sign::mutable_junction_names(int index) {
  // @@protoc_insertion_point(field_mutable:valhalla.TripLeg.Sign.junction_names)
  return junction_names_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::valhalla::TripLeg_SignElement >*
TripLeg_Sign::mutable_junction_names() {
  // @@protoc_insertion_point(field_mutable_list:valhalla.TripLeg.Sign.junction_names)
  return &junction_names_;
}
inline const ::valhalla::TripLeg_SignElement& TripLeg_Sign::_internal_junction_names(int index) const {
  return junction_names_.Get(index);
}
inline const ::valhalla::TripLeg_SignElement& TripLeg_Sign::junction_names(int index) const {
  // @@protoc_insertion_point(field_get:valhalla.TripLeg.Sign.junction_names)
  return _internal_junction_names(index);
}
inline ::valhalla::TripLeg_SignElement* TripLeg_Sign::_internal_add_junction_names() {
  return junction_names_.Add();
}
inline ::valhalla::TripLeg_SignElement* TripLeg_Sign::add_junction_names() {
  // @@protoc_insertion_point(field_add:valhalla.TripLeg.Sign.junction_names)
  return _internal_add_junction_names();
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::valhalla::TripLeg_SignElement >&
TripLeg_Sign::junction_names() const {
  // @@protoc_insertion_point(field_list:valhalla.TripLeg.Sign.junction_names)
  return junction_names_;
}

// repeated .valhalla.TripLeg.SignElement guidance_view_junctions = 8;
inline int TripLeg_Sign::_internal_guidance_view_junctions_size() const {
  return guidance_view_junctions_.size();
}
inline int TripLeg_Sign::guidance_view_junctions_size() const {
  return _internal_guidance_view_junctions_size();
}
inline void TripLeg_Sign::clear_guidance_view_junctions() {
  guidance_view_junctions_.Clear();
}
inline ::valhalla::TripLeg_SignElement* TripLeg_Sign::mutable_guidance_view_junctions(int index) {
  // @@protoc_insertion_point(field_mutable:valhalla.TripLeg.Sign.guidance_view_junctions)
  return guidance_view_junctions_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::valhalla::TripLeg_SignElement >*
TripLeg_Sign::mutable_guidance_view_junctions() {
  // @@protoc_insertion_point(field_mutable_list:valhalla.TripLeg.Sign.guidance_view_junctions)
  return &guidance_view_junctions_;
}
inline const ::valhalla::TripLeg_SignElement& TripLeg_Sign::_internal_guidance_view_junctions(int index) const {
  return guidance_view_junctions_.Get(index);
}
inline const ::valhalla::TripLeg_SignElement& TripLeg_Sign::guidance_view_junctions(int index) const {
  // @@protoc_insertion_point(field_get:valhalla.TripLeg.Sign.guidance_view_junctions)
  return _internal_guidance_view_junctions(index);
}
inline ::valhalla::TripLeg_SignElement* TripLeg_Sign::_internal_add_guidance_view_junctions() {
  return guidance_view_junctions_.Add();
}
inline ::valhalla::TripLeg_SignElement* TripLeg_Sign::add_guidance_view_junctions() {
  // @@protoc_insertion_point(field_add:valhalla.TripLeg.Sign.guidance_view_junctions)
  return _internal_add_guidance_view_junctions();
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::valhalla::TripLeg_SignElement >&
TripLeg_Sign::guidance_view_junctions() const {
  // @@protoc_insertion_point(field_list:valhalla.TripLeg.Sign.guidance_view_junctions)
  return guidance_view_junctions_;
}

// repeated .valhalla.TripLeg.SignElement guidance_view_signboards = 9;
inline int TripLeg_Sign::_internal_guidance_view_signboards_size() const {
  return guidance_view_signboards_.size();
}
inline int TripLeg_Sign::guidance_view_signboards_size() const {
  return _internal_guidance_view_signboards_size();
}
inline void TripLeg_Sign::clear_guidance_view_signboards() {
  guidance_view_signboards_.Clear();
}
inline ::valhalla::TripLeg_SignElement* TripLeg_Sign::mutable_guidance_view_signboards(int index) {
  // @@protoc_insertion_point(field_mutable:valhalla.TripLeg.Sign.guidance_view_signboards)
  return guidance_view_signboards_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::valhalla::TripLeg_SignElement >*
TripLeg_Sign::mutable_guidance_view_signboards() {
  // @@protoc_insertion_point(field_mutable_list:valhalla.TripLeg.Sign.guidance_view_signboards)
  return &guidance_view_signboards_;
}
inline const ::valhalla::TripLeg_SignElement& TripLeg_Sign::_internal_guidance_view_signboards(int index) const {
  return guidance_view_signboards_.Get(index);
}
inline const ::valhalla::TripLeg_SignElement& TripLeg_Sign::guidance_view_signboards(int index) const {
  // @@protoc_insertion_point(field_get:valhalla.TripLeg.Sign.guidance_view_signboards)
  return _internal_guidance_view_signboards(index);
}
inline ::valhalla::TripLeg_SignElement* TripLeg_Sign::_internal_add_guidance_view_signboards() {
  return guidance_view_signboards_.Add();
}
inline ::valhalla::TripLeg_SignElement* TripLeg_Sign::add_guidance_view_signboards() {
  // @@protoc_insertion_point(field_add:valhalla.TripLeg.Sign.guidance_view_signboards)
  return _internal_add_guidance_view_signboards();
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::valhalla::TripLeg_SignElement >&
TripLeg_Sign::guidance_view_signboards() const {
  // @@protoc_insertion_point(field_list:valhalla.TripLeg.Sign.guidance_view_signboards)
  return guidance_view_signboards_;
}
...
// optional string onestop_id = 1;
inline bool TripLeg_TransitRouteInfo::_internal_has_onestop_id() const {
  bool value = (_has_bits_[0] & 0x00000001u) != 0;
  return value;
}
...
inline const std::string& TripLeg_TransitRouteInfo::onestop_id() const {
  // @@protoc_insertion_point(field_get:valhalla.TripLeg.TransitRouteInfo.onestop_id)
...
inline void TripLeg_TransitRouteInfo::set_onestop_id(const std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:valhalla.TripLeg.TransitRouteInfo.onestop_id)
}
inline std::string* TripLeg_TransitRouteInfo::mutable_onestop_id() {
  // @@protoc_insertion_point(field_mutable:valhalla.TripLeg.TransitRouteInfo.onestop_id)
  return _internal_mutable_onestop_id();
}
inline const std::string& TripLeg_TransitRouteInfo::_internal_onestop_id() const {
  return onestop_id_.Get();
}
inline void TripLeg_TransitRouteInfo::_internal_set_onestop_id(const std::string& value) {
  _has_bits_[0] |= 0x00000001u;
  onestop_id_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
inline void TripLeg_TransitRouteInfo::set_onestop_id(std::string&& value) {
  _has_bits_[0] |= 0x00000001u;
  onestop_id_.Set(
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:valhalla.TripLeg.TransitRouteInfo.onestop_id)
}
inline void TripLeg_TransitRouteInfo::set_onestop_id(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _has_bits_[0] |= 0x00000001u;
  onestop_id_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:valhalla.TripLeg.TransitRouteInfo.onestop_id)
}
inline void TripLeg_TransitRouteInfo::set_onestop_id(const char* value,
    size_t size) {
  _has_bits_[0] |= 0x00000001u;
  onestop_id_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:valhalla.TripLeg.TransitRouteInfo.onestop_id)
}
inline std::string* TripLeg_TransitRouteInfo::_internal_mutable_onestop_id() {
  _has_bits_[0] |= 0x00000001u;
  return onestop_id_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
}
inline std::string* TripLeg_TransitRouteInfo::release_onestop_id() {
  // @@protoc_insertion_point(field_release:valhalla.TripLeg.TransitRouteInfo.onestop_id)
...
inline void TripLeg_TransitRouteInfo::set_allocated_onestop_id(std::string* onestop_id) {
  ...
  onestop_id_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), onestop_id,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:valhalla.TripLeg.TransitRouteInfo.onestop_id)
}

// optional uint32 block_id = 2;
inline bool TripLeg_TransitRouteInfo::_internal_has_block_id() const {
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 TripLeg_TransitRouteInfo::_internal_block_id() const {
  return block_id_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 TripLeg_TransitRouteInfo::block_id() const {
  // @@protoc_insertion_point(field_get:valhalla.TripLeg.TransitRouteInfo.block_id)
  return _internal_block_id();
}
inline void TripLeg_TransitRouteInfo::_internal_set_block_id(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  _has_bits_[0] |= 0x00000100u;
  block_id_ = value;
}
inline void TripLeg_TransitRouteInfo::set_block_id(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  _internal_set_block_id(value);
  // @@protoc_insertion_point(field_set:valhalla.TripLeg.TransitRouteInfo.block_id)
}

// optional uint32 trip_id = 3;
inline bool TripLeg_TransitRouteInfo::_internal_has_trip_id() const {
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 TripLeg_TransitRouteInfo::_internal_trip_id() const {
  return trip_id_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 TripLeg_TransitRouteInfo::trip_id() const {
  // @@protoc_insertion_point(field_get:valhalla.TripLeg.TransitRouteInfo.trip_id)
  return _internal_trip_id();
}
inline void TripLeg_TransitRouteInfo::_internal_set_trip_id(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  _has_bits_[0] |= 0x00000200u;
  trip_id_ = value;
}
inline void TripLeg_TransitRouteInfo::set_trip_id(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  _internal_set_trip_id(value);
  // @@protoc_insertion_point(field_set:valhalla.TripLeg.TransitRouteInfo.trip_id)
}

// optional string short_name = 4;
inline bool TripLeg_TransitRouteInfo::_internal_has_short_name() const {
  bool value = (_has_bits_[0] & 0x00000002u) != 0;
  return value;
}
...
inline const std::string& TripLeg_TransitRouteInfo::short_name() const {
  // @@protoc_insertion_point(field_get:valhalla.TripLeg.TransitRouteInfo.short_name)
...
inline void TripLeg_TransitRouteInfo::set_short_name(const std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:valhalla.TripLeg.TransitRouteInfo.short_name)
}
inline std::string* TripLeg_TransitRouteInfo::mutable_short_name() {
  // @@protoc_insertion_point(field_mutable:valhalla.TripLeg.TransitRouteInfo.short_name)
  return _internal_mutable_short_name();
}
inline const std::string& TripLeg_TransitRouteInfo::_internal_short_name() const {
  return short_name_.Get();
}
inline void TripLeg_TransitRouteInfo::_internal_set_short_name(const std::string& value) {
  _has_bits_[0] |= 0x00000002u;
  short_name_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
inline void TripLeg_TransitRouteInfo::set_short_name(std::string&& value) {
  _has_bits_[0] |= 0x00000002u;
  short_name_.Set(
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:valhalla.TripLeg.TransitRouteInfo.short_name)
}
inline void TripLeg_TransitRouteInfo::set_short_name(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:valhalla.TripLeg.TransitRouteInfo.short_name)
}
inline void TripLeg_TransitRouteInfo::set_short_name(const char* value,
    size_t size) {
  _has_bits_[0] |= 0x00000002u;
  short_name_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:valhalla.TripLeg.TransitRouteInfo.short_name)
}
inline std::string* TripLeg_TransitRouteInfo::_internal_mutable_short_name() {
  _has_bits_[0] |= 0x00000002u;
...
inline std::string* TripLeg_TransitRouteInfo::release_short_name() {
  // @@protoc_insertion_point(field_release:valhalla.TripLeg.TransitRouteInfo.short_name)
...
inline void TripLeg_TransitRouteInfo::set_allocated_short_name(std::string* short_name) {
  ...
  short_name_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), short_name,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:valhalla.TripLeg.TransitRouteInfo.short_name)
}

// optional string long_name = 5;
inline bool TripLeg_TransitRouteInfo::_internal_has_long_name() const {
...
inline const std::string& TripLeg_TransitRouteInfo::long_name() const {
  // @@protoc_insertion_point(field_get:valhalla.TripLeg.TransitRouteInfo.long_name)
...
inline void TripLeg_TransitRouteInfo::set_long_name(const std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:valhalla.TripLeg.TransitRouteInfo.long_name)
}
inline std::string* TripLeg_TransitRouteInfo::mutable_long_name() {
  // @@protoc_insertion_point(field_mutable:valhalla.TripLeg.TransitRouteInfo.long_name)
  return _internal_mutable_long_name();
}
inline const std::string& TripLeg_TransitRouteInfo::_internal_long_name() const {
  return long_name_.Get();
}
inline void TripLeg_TransitRouteInfo::_internal_set_long_name(const std::string& value) {
  _has_bits_[0] |= 0x00000004u;
  long_name_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
inline void TripLeg_TransitRouteInfo::set_long_name(std::string&& value) {
  _has_bits_[0] |= 0x00000004u;
  long_name_.Set(
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:valhalla.TripLeg.TransitRouteInfo.long_name)
}
inline void TripLeg_TransitRouteInfo::set_long_name(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _has_bits_[0] |= 0x00000004u;
  long_name_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:valhalla.TripLeg.TransitRouteInfo.long_name)
}
inline void TripLeg_TransitRouteInfo::set_long_name(const char* value,
    size_t size) {
  _has_bits_[0] |= 0x00000004u;
  long_name_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:valhalla.TripLeg.TransitRouteInfo.long_name)
}
inline std::string* TripLeg_TransitRouteInfo::_internal_mutable_long_name() {
  _has_bits_[0] |= 0x00000004u;
  return long_name_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
}
inline std::string* TripLeg_TransitRouteInfo::release_long_name() {
  // @@protoc_insertion_point(field_release:valhalla.TripLeg.TransitRouteInfo.long_name)
...
inline void TripLeg_TransitRouteInfo::set_allocated_long_name(std::string* long_name) {
  ...
  long_name_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), long_name,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:valhalla.TripLeg.TransitRouteInfo.long_name)
}

// optional string headsign = 6;
inline bool TripLeg_TransitRouteInfo::_internal_has_headsign() const {
...
inline const std::string& TripLeg_TransitRouteInfo::headsign() const {
  // @@protoc_insertion_point(field_get:valhalla.TripLeg.TransitRouteInfo.headsign)
...
inline void TripLeg_TransitRouteInfo::set_headsign(const std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:valhalla.TripLeg.TransitRouteInfo.headsign)
}
inline std::string* TripLeg_TransitRouteInfo::mutable_headsign() {
  // @@protoc_insertion_point(field_mutable:valhalla.TripLeg.TransitRouteInfo.headsign)
  return _internal_mutable_headsign();
}
inline const std::string& TripLeg_TransitRouteInfo::_internal_headsign() const {
  return headsign_.Get();
}
inline void TripLeg_TransitRouteInfo::_internal_set_headsign(const std::string& value) {
  _has_bits_[0] |= 0x00000008u;
  headsign_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
inline void TripLeg_TransitRouteInfo::set_headsign(std::string&& value) {
  _has_bits_[0] |= 0x00000008u;
  headsign_.Set(
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:valhalla.TripLeg.TransitRouteInfo.headsign)
}
inline void TripLeg_TransitRouteInfo::set_headsign(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _has_bits_[0] |= 0x00000008u;
  headsign_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:valhalla.TripLeg.TransitRouteInfo.headsign)
}
inline void TripLeg_TransitRouteInfo::set_headsign(const char* value,
    size_t size) {
  _has_bits_[0] |= 0x00000008u;
  headsign_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:valhalla.TripLeg.TransitRouteInfo.headsign)
}
inline std::string* TripLeg_TransitRouteInfo::_internal_mutable_headsign() {
  _has_bits_[0] |= 0x00000008u;
  return headsign_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
}
inline std::string* TripLeg_TransitRouteInfo::release_headsign() {
  // @@protoc_insertion_point(field_release:valhalla.TripLeg.TransitRouteInfo.headsign)
  if (!_internal_has_headsign()) {
    return nullptr;
  }
  _has_bits_[0] &= ~0x00000008u;
  return headsign_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline void TripLeg_TransitRouteInfo::set_allocated_headsign(std::string* headsign) {
  ...
  headsign_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), headsign,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:valhalla.TripLeg.TransitRouteInfo.headsign)
}

// optional uint32 color = 7;
inline bool TripLeg_TransitRouteInfo::_internal_has_color() const {
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 TripLeg_TransitRouteInfo::_internal_color() const {
  return color_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 TripLeg_TransitRouteInfo::color() const {
  // @@protoc_insertion_point(field_get:valhalla.TripLeg.TransitRouteInfo.color)
  return _internal_color();
}
inline void TripLeg_TransitRouteInfo::_internal_set_color(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  _has_bits_[0] |= 0x00000400u;
  color_ = value;
}
inline void TripLeg_TransitRouteInfo::set_color(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  _internal_set_color(value);
  // @@protoc_insertion_point(field_set:valhalla.TripLeg.TransitRouteInfo.color)
}

// optional uint32 text_color = 8;
inline bool TripLeg_TransitRouteInfo::_internal_has_text_color() const {
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 TripLeg_TransitRouteInfo::_internal_text_color() const {
  return text_color_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 TripLeg_TransitRouteInfo::text_color() const {
  // @@protoc_insertion_point(field_get:valhalla.TripLeg.TransitRouteInfo.text_color)
  return _internal_text_color();
}
inline void TripLeg_TransitRouteInfo::_internal_set_text_color(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  _has_bits_[0] |= 0x00000800u;
  text_color_ = value;
}
inline void TripLeg_TransitRouteInfo::set_text_color(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  _internal_set_text_color(value);
  // @@protoc_insertion_point(field_set:valhalla.TripLeg.TransitRouteInfo.text_color)
}

// optional string description = 9;
inline bool TripLeg_TransitRouteInfo::_internal_has_description() const {
...
inline const std::string& TripLeg_TransitRouteInfo::description() const {
  // @@protoc_insertion_point(field_get:valhalla.TripLeg.TransitRouteInfo.description)
  return _internal_description();
}
inline void TripLeg_TransitRouteInfo::set_description(const std::string& value) {
  _internal_set_description(value);
  // @@protoc_insertion_point(field_set:valhalla.TripLeg.TransitRouteInfo.description)
}
inline std::string* TripLeg_TransitRouteInfo::mutable_description() {
  // @@protoc_insertion_point(field_mutable:valhalla.TripLeg.TransitRouteInfo.description)
  return _internal_mutable_description();
}
inline const std::string& TripLeg_TransitRouteInfo::_internal_description() const {
  return description_.Get();
}
inline void TripLeg_TransitRouteInfo::_internal_set_description(const std::string& value) {
  _has_bits_[0] |= 0x00000010u;
  description_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
inline void TripLeg_TransitRouteInfo::set_description(std::string&& value) {
  _has_bits_[0] |= 0x00000010u;
  description_.Set(
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:valhalla.TripLeg.TransitRouteInfo.description)
}
inline void TripLeg_TransitRouteInfo::set_description(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _has_bits_[0] |= 0x00000010u;
  description_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:valhalla.TripLeg.TransitRouteInfo.description)
}
inline void TripLeg_TransitRouteInfo::set_description(const char* value,
    size_t size) {
  _has_bits_[0] |= 0x00000010u;
  description_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:valhalla.TripLeg.TransitRouteInfo.description)
}
inline std::string* TripLeg_TransitRouteInfo::_internal_mutable_description() {
  _has_bits_[0] |= 0x00000010u;
  return description_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
}
inline std::string* TripLeg_TransitRouteInfo::release_description() {
  // @@protoc_insertion_point(field_release:valhalla.TripLeg.TransitRouteInfo.description)
...
inline void TripLeg_TransitRouteInfo::set_allocated_description(std::string* description) {
  ...
  description_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), description,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:valhalla.TripLeg.TransitRouteInfo.description)
}

// optional string operator_onestop_id = 10;
inline bool TripLeg_TransitRouteInfo::_internal_has_operator_onestop_id() const {
...
inline const std::string& TripLeg_TransitRouteInfo::operator_onestop_id() const {
  // @@protoc_insertion_point(field_get:valhalla.TripLeg.TransitRouteInfo.operator_onestop_id)
...
inline void TripLeg_TransitRouteInfo::set_operator_onestop_id(const std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:valhalla.TripLeg.TransitRouteInfo.operator_onestop_id)
}
inline std::string* TripLeg_TransitRouteInfo::mutable_operator_onestop_id() {
  // @@protoc_insertion_point(field_mutable:valhalla.TripLeg.TransitRouteInfo.operator_onestop_id)
  return _internal_mutable_operator_onestop_id();
}
inline const std::string& TripLeg_TransitRouteInfo::_internal_operator_onestop_id() const {
  return operator_onestop_id_.Get();
}
inline void TripLeg_TransitRouteInfo::_internal_set_operator_onestop_id(const std::string& value) {
  _has_bits_[0] |= 0x00000020u;
  operator_onestop_id_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
inline void TripLeg_TransitRouteInfo::set_operator_onestop_id(std::string&& value) {
  _has_bits_[0] |= 0x00000020u;
  operator_onestop_id_.Set(
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:valhalla.TripLeg.TransitRouteInfo.operator_onestop_id)
}
inline void TripLeg_TransitRouteInfo::set_operator_onestop_id(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _has_bits_[0] |= 0x00000020u;
  operator_onestop_id_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:valhalla.TripLeg.TransitRouteInfo.operator_onestop_id)
}
inline void TripLeg_TransitRouteInfo::set_operator_onestop_id(const char* value,
    size_t size) {
  _has_bits_[0] |= 0x00000020u;
  operator_onestop_id_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:valhalla.TripLeg.TransitRouteInfo.operator_onestop_id)
}
inline std::string* TripLeg_TransitRouteInfo::_internal_mutable_operator_onestop_id() {
  _has_bits_[0] |= 0x00000020u;
  return operator_onestop_id_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
}
inline std::string* TripLeg_TransitRouteInfo::release_operator_onestop_id() {
  // @@protoc_insertion_point(field_release:valhalla.TripLeg.TransitRouteInfo.operator_onestop_id)
  if (!_internal_has_operator_onestop_id()) {
    return nullptr;
  }
  _has_bits_[0] &= ~0x00000020u;
  return operator_onestop_id_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline void TripLeg_TransitRouteInfo::set_allocated_operator_onestop_id(std::string* operator_onestop_id) {
  ...
  operator_onestop_id_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), operator_onestop_id,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:valhalla.TripLeg.TransitRouteInfo.operator_onestop_id)
}

// optional string operator_name = 11;
inline bool TripLeg_TransitRouteInfo::_internal_has_operator_name() const {
...
inline const std::string& TripLeg_TransitRouteInfo::operator_name() const {
  // @@protoc_insertion_point(field_get:valhalla.TripLeg.TransitRouteInfo.operator_name)
...
inline void TripLeg_TransitRouteInfo::set_operator_name(const std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:valhalla.TripLeg.TransitRouteInfo.operator_name)
}
inline std::string* TripLeg_TransitRouteInfo::mutable_operator_name() {
  // @@protoc_insertion_point(field_mutable:valhalla.TripLeg.TransitRouteInfo.operator_name)
  return _internal_mutable_operator_name();
}
inline const std::string& TripLeg_TransitRouteInfo::_internal_operator_name() const {
  return operator_name_.Get();
}
inline void TripLeg_TransitRouteInfo::_internal_set_operator_name(const std::string& value) {
  _has_bits_[0] |= 0x00000040u;
  operator_name_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
inline void TripLeg_TransitRouteInfo::set_operator_name(std::string&& value) {
  _has_bits_[0] |= 0x00000040u;
  operator_name_.Set(
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:valhalla.TripLeg.TransitRouteInfo.operator_name)
}
inline void TripLeg_TransitRouteInfo::set_operator_name(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:valhalla.TripLeg.TransitRouteInfo.operator_name)
}
inline void TripLeg_TransitRouteInfo::set_operator_name(const char* value,
    size_t size) {
  _has_bits_[0] |= 0x00000040u;
  operator_name_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:valhalla.TripLeg.TransitRouteInfo.operator_name)
}
inline std::string* TripLeg_TransitRouteInfo::_internal_mutable_operator_name() {
  _has_bits_[0] |= 0x00000040u;
...
inline std::string* TripLeg_TransitRouteInfo::release_operator_name() {
  // @@protoc_insertion_point(field_release:valhalla.TripLeg.TransitRouteInfo.operator_name)
  if (!_internal_has_operator_name()) {
    return nullptr;
  }
  _has_bits_[0] &= ~0x00000040u;
  return operator_name_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline void TripLeg_TransitRouteInfo::set_allocated_operator_name(std::string* operator_name) {
  ...
  operator_name_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), operator_name,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:valhalla.TripLeg.TransitRouteInfo.operator_name)
}

// optional string operator_url = 12;
inline bool TripLeg_TransitRouteInfo::_internal_has_operator_url() const {
...
inline const std::string& TripLeg_TransitRouteInfo::operator_url() const {
  // @@protoc_insertion_point(field_get:valhalla.TripLeg.TransitRouteInfo.operator_url)
...
inline void TripLeg_TransitRouteInfo::set_operator_url(const std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:valhalla.TripLeg.TransitRouteInfo.operator_url)
}
inline std::string* TripLeg_TransitRouteInfo::mutable_operator_url() {
  // @@protoc_insertion_point(field_mutable:valhalla.TripLeg.TransitRouteInfo.operator_url)
  return _internal_mutable_operator_url();
}
inline const std::string& TripLeg_TransitRouteInfo::_internal_operator_url() const {
  return operator_url_.Get();
}
inline void TripLeg_TransitRouteInfo::_internal_set_operator_url(const std::string& value) {
  _has_bits_[0] |= 0x00000080u;
  operator_url_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
inline void TripLeg_TransitRouteInfo::set_operator_url(std::string&& value) {
  _has_bits_[0] |= 0x00000080u;
  operator_url_.Set(
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:valhalla.TripLeg.TransitRouteInfo.operator_url)
}
inline void TripLeg_TransitRouteInfo::set_operator_url(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _has_bits_[0] |= 0x00000080u;
  operator_url_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:valhalla.TripLeg.TransitRouteInfo.operator_url)
}
inline void TripLeg_TransitRouteInfo::set_operator_url(const char* value,
    size_t size) {
  _has_bits_[0] |= 0x00000080u;
  operator_url_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:valhalla.TripLeg.TransitRouteInfo.operator_url)
}
inline std::string* TripLeg_TransitRouteInfo::_internal_mutable_operator_url() {
  _has_bits_[0] |= 0x00000080u;
  return operator_url_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
}
inline std::string* TripLeg_TransitRouteInfo::release_operator_url() {
  // @@protoc_insertion_point(field_release:valhalla.TripLeg.TransitRouteInfo.operator_url)
  if (!_internal_has_operator_url()) {
    return nullptr;
  }
  _has_bits_[0] &= ~0x00000080u;
  return operator_url_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline void TripLeg_TransitRouteInfo::set_allocated_operator_url(std::string* operator_url) {
  ...
  operator_url_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), operator_url,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:valhalla.TripLeg.TransitRouteInfo.operator_url)
}
...
// optional string name = 1;
inline bool TripLeg_BikeShareStationInfo::_internal_has_name() const {
  bool value = (_has_bits_[0] & 0x00000001u) != 0;
  return value;
}
inline bool TripLeg_BikeShareStationInfo::has_name() const {
  return _internal_has_name();
}
inline void TripLeg_BikeShareStationInfo::clear_name() {
  name_.ClearToEmpty();
  _has_bits_[0] &= ~0x00000001u;
}
inline const std::string& TripLeg_BikeShareStationInfo::name() const {
  // @@protoc_insertion_point(field_get:valhalla.TripLeg.BikeShareStationInfo.name)
  return _internal_name();
}
inline void TripLeg_BikeShareStationInfo::set_name(const std::string& value) {
  _internal_set_name(value);
  // @@protoc_insertion_point(field_set:valhalla.TripLeg.BikeShareStationInfo.name)
}
inline std::string* TripLeg_BikeShareStationInfo::mutable_name() {
  // @@protoc_insertion_point(field_mutable:valhalla.TripLeg.BikeShareStationInfo.name)
  return _internal_mutable_name();
}
inline const std::string& TripLeg_BikeShareStationInfo::_internal_name() const {
  return name_.Get();
}
inline void TripLeg_BikeShareStationInfo::_internal_set_name(const std::string& value) {
  _has_bits_[0] |= 0x00000001u;
  name_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
inline void TripLeg_BikeShareStationInfo::set_name(std::string&& value) {
  _has_bits_[0] |= 0x00000001u;
  name_.Set(
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:valhalla.TripLeg.BikeShareStationInfo.name)
}
inline void TripLeg_BikeShareStationInfo::set_name(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _has_bits_[0] |= 0x00000001u;
  name_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:valhalla.TripLeg.BikeShareStationInfo.name)
}
inline void TripLeg_BikeShareStationInfo::set_name(const char* value,
    size_t size) {
  _has_bits_[0] |= 0x00000001u;
  name_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:valhalla.TripLeg.BikeShareStationInfo.name)
}
inline std::string* TripLeg_BikeShareStationInfo::_internal_mutable_name() {
  _has_bits_[0] |= 0x00000001u;
  return name_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
}
inline std::string* TripLeg_BikeShareStationInfo::release_name() {
  // @@protoc_insertion_point(field_release:valhalla.TripLeg.BikeShareStationInfo.name)
...
inline void TripLeg_BikeShareStationInfo::set_allocated_name(std::string* name) {
  if (name != nullptr) {
    _has_bits_[0] |= 0x00000001u;
  } else {
    _has_bits_[0] &= ~0x00000001u;
  ...
  name_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), name,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:valhalla.TripLeg.BikeShareStationInfo.name)
}

// optional string ref = 2;
inline bool TripLeg_BikeShareStationInfo::_internal_has_ref() const {
  bool value = (_has_bits_[0] & 0x00000002u) != 0;
  return value;
}
inline bool TripLeg_BikeShareStationInfo::has_ref() const {
  return _internal_has_ref();
}
inline void TripLeg_BikeShareStationInfo::clear_ref() {
  ref_.ClearToEmpty();
  _has_bits_[0] &= ~0x00000002u;
}
inline const std::string& TripLeg_BikeShareStationInfo::ref() const {
  // @@protoc_insertion_point(field_get:valhalla.TripLeg.BikeShareStationInfo.ref)
  return _internal_ref();
}
inline void TripLeg_BikeShareStationInfo::set_ref(const std::string& value) {
  _internal_set_ref(value);
  // @@protoc_insertion_point(field_set:valhalla.TripLeg.BikeShareStationInfo.ref)
}
inline std::string* TripLeg_BikeShareStationInfo::mutable_ref() {
  // @@protoc_insertion_point(field_mutable:valhalla.TripLeg.BikeShareStationInfo.ref)
  return _internal_mutable_ref();
}
inline const std::string& TripLeg_BikeShareStationInfo::_internal_ref() const {
  return ref_.Get();
}
inline void TripLeg_BikeShareStationInfo::_internal_set_ref(const std::string& value) {
  _has_bits_[0] |= 0x00000002u;
  ref_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
inline void TripLeg_BikeShareStationInfo::set_ref(std::string&& value) {
  _has_bits_[0] |= 0x00000002u;
  ref_.Set(
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:valhalla.TripLeg.BikeShareStationInfo.ref)
}
inline void TripLeg_BikeShareStationInfo::set_ref(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _has_bits_[0] |= 0x00000002u;
  ref_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:valhalla.TripLeg.BikeShareStationInfo.ref)
}
inline void TripLeg_BikeShareStationInfo::set_ref(const char* value,
    size_t size) {
  _has_bits_[0] |= 0x00000002u;
  ref_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:valhalla.TripLeg.BikeShareStationInfo.ref)
}
inline std::string* TripLeg_BikeShareStationInfo::_internal_mutable_ref() {
  _has_bits_[0] |= 0x00000002u;
  return ref_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
}
inline std::string* TripLeg_BikeShareStationInfo::release_ref() {
  // @@protoc_insertion_point(field_release:valhalla.TripLeg.BikeShareStationInfo.ref)
...
inline void TripLeg_BikeShareStationInfo::set_allocated_ref(std::string* ref) {
  if (ref != nullptr) {
    _has_bits_[0] |= 0x00000002u;
  } else {
    _has_bits_[0] &= ~0x00000002u;
  ...
  ref_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ref,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:valhalla.TripLeg.BikeShareStationInfo.ref)
}

// optional string capacity = 3;
inline bool TripLeg_BikeShareStationInfo::_internal_has_capacity() const {
  bool value = (_has_bits_[0] & 0x00000004u) != 0;
  return value;
}
inline bool TripLeg_BikeShareStationInfo::has_capacity() const {
  return _internal_has_capacity();
}
inline void TripLeg_BikeShareStationInfo::clear_capacity() {
  capacity_.ClearToEmpty();
  _has_bits_[0] &= ~0x00000004u;
}
inline const std::string& TripLeg_BikeShareStationInfo::capacity() const {
  // @@protoc_insertion_point(field_get:valhalla.TripLeg.BikeShareStationInfo.capacity)
  return _internal_capacity();
}
inline void TripLeg_BikeShareStationInfo::set_capacity(const std::string& value) {
  _internal_set_capacity(value);
  // @@protoc_insertion_point(field_set:valhalla.TripLeg.BikeShareStationInfo.capacity)
}
inline std::string* TripLeg_BikeShareStationInfo::mutable_capacity() {
  // @@protoc_insertion_point(field_mutable:valhalla.TripLeg.BikeShareStationInfo.capacity)
  return _internal_mutable_capacity();
}
inline const std::string& TripLeg_BikeShareStationInfo::_internal_capacity() const {
  return capacity_.Get();
}
inline void TripLeg_BikeShareStationInfo::_internal_set_capacity(const std::string& value) {
  _has_bits_[0] |= 0x00000004u;
  capacity_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
inline void TripLeg_BikeShareStationInfo::set_capacity(std::string&& value) {
  _has_bits_[0] |= 0x00000004u;
  capacity_.Set(
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:valhalla.TripLeg.BikeShareStationInfo.capacity)
}
inline void TripLeg_BikeShareStationInfo::set_capacity(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _has_bits_[0] |= 0x00000004u;
  capacity_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:valhalla.TripLeg.BikeShareStationInfo.capacity)
}
inline void TripLeg_BikeShareStationInfo::set_capacity(const char* value,
    size_t size) {
  _has_bits_[0] |= 0x00000004u;
  capacity_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:valhalla.TripLeg.BikeShareStationInfo.capacity)
}
inline std::string* TripLeg_BikeShareStationInfo::_internal_mutable_capacity() {
  _has_bits_[0] |= 0x00000004u;
  return capacity_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
}
inline std::string* TripLeg_BikeShareStationInfo::release_capacity() {
  // @@protoc_insertion_point(field_release:valhalla.TripLeg.BikeShareStationInfo.capacity)
  if (!_internal_has_capacity()) {
    return nullptr;
  }
  _has_bits_[0] &= ~0x00000004u;
  return capacity_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline void TripLeg_BikeShareStationInfo::set_allocated_capacity(std::string* capacity) {
  if (capacity != nullptr) {
    _has_bits_[0] |= 0x00000004u;
  } else {
    _has_bits_[0] &= ~0x00000004u;
  ...
  capacity_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), capacity,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:valhalla.TripLeg.BikeShareStationInfo.capacity)
}

// optional string network = 4;
inline bool TripLeg_BikeShareStationInfo::_internal_has_network() const {
  bool value = (_has_bits_[0] & 0x00000008u) != 0;
  return value;
}
inline bool TripLeg_BikeShareStationInfo::has_network() const {
  return _internal_has_network();
}
inline void TripLeg_BikeShareStationInfo::clear_network() {
  network_.ClearToEmpty();
  _has_bits_[0] &= ~0x00000008u;
}
inline const std::string& TripLeg_BikeShareStationInfo::network() const {
  // @@protoc_insertion_point(field_get:valhalla.TripLeg.BikeShareStationInfo.network)
  return _internal_network();
}
inline void TripLeg_BikeShareStationInfo::set_network(const std::string& value) {
  _internal_set_network(value);
  // @@protoc_insertion_point(field_set:valhalla.TripLeg.BikeShareStationInfo.network)
}
inline std::string* TripLeg_BikeShareStationInfo::mutable_network() {
  // @@protoc_insertion_point(field_mutable:valhalla.TripLeg.BikeShareStationInfo.network)
  return _internal_mutable_network();
}
inline const std::string& TripLeg_BikeShareStationInfo::_internal_network() const {
  return network_.Get();
}
inline void TripLeg_BikeShareStationInfo::_internal_set_network(const std::string& value) {
  _has_bits_[0] |= 0x00000008u;
  network_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
inline void TripLeg_BikeShareStationInfo::set_network(std::string&& value) {
  _has_bits_[0] |= 0x00000008u;
  network_.Set(
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:valhalla.TripLeg.BikeShareStationInfo.network)
}
inline void TripLeg_BikeShareStationInfo::set_network(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _has_bits_[0] |= 0x00000008u;
  network_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:valhalla.TripLeg.BikeShareStationInfo.network)
}
inline void TripLeg_BikeShareStationInfo::set_network(const char* value,
    size_t size) {
  _has_bits_[0] |= 0x00000008u;
  network_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:valhalla.TripLeg.BikeShareStationInfo.network)
}
inline std::string* TripLeg_BikeShareStationInfo::_internal_mutable_network() {
  _has_bits_[0] |= 0x00000008u;
  return network_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
}
inline std::string* TripLeg_BikeShareStationInfo::release_network() {
  // @@protoc_insertion_point(field_release:valhalla.TripLeg.BikeShareStationInfo.network)
  if (!_internal_has_network()) {
    return nullptr;
  }
  _has_bits_[0] &= ~0x00000008u;
  return network_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline void TripLeg_BikeShareStationInfo::set_allocated_network(std::string* network) {
  if (network != nullptr) {
    _has_bits_[0] |= 0x00000008u;
  } else {
    _has_bits_[0] &= ~0x00000008u;
  ...
  network_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), network,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:valhalla.TripLeg.BikeShareStationInfo.network)
}

// optional string operator = 5;
inline bool TripLeg_BikeShareStationInfo::_internal_has_operator_() const {
  bool value = (_has_bits_[0] & 0x00000010u) != 0;
  return value;
}
inline bool TripLeg_BikeShareStationInfo::has_operator_() const {
  return _internal_has_operator_();
}
inline void TripLeg_BikeShareStationInfo::clear_operator_() {
  operator__.ClearToEmpty();
  _has_bits_[0] &= ~0x00000010u;
}
inline const std::string& TripLeg_BikeShareStationInfo::operator_() const {
  // @@protoc_insertion_point(field_get:valhalla.TripLeg.BikeShareStationInfo.operator)
  return _internal_operator_();
}
inline void TripLeg_BikeShareStationInfo::set_operator_(const std::string& value) {
  _internal_set_operator_(value);
  // @@protoc_insertion_point(field_set:valhalla.TripLeg.BikeShareStationInfo.operator)
}
inline std::string* TripLeg_BikeShareStationInfo::mutable_operator_() {
  // @@protoc_insertion_point(field_mutable:valhalla.TripLeg.BikeShareStationInfo.operator)
  return _internal_mutable_operator_();
}
inline const std::string& TripLeg_BikeShareStationInfo::_internal_operator_() const {
  return operator__.Get();
}
inline void TripLeg_BikeShareStationInfo::_internal_set_operator_(const std::string& value) {
  _has_bits_[0] |= 0x00000010u;
  operator__.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
inline void TripLeg_BikeShareStationInfo::set_operator_(std::string&& value) {
  _has_bits_[0] |= 0x00000010u;
  operator__.Set(
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:valhalla.TripLeg.BikeShareStationInfo.operator)
}
inline void TripLeg_BikeShareStationInfo::set_operator_(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _has_bits_[0] |= 0x00000010u;
  operator__.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:valhalla.TripLeg.BikeShareStationInfo.operator)
}
inline void TripLeg_BikeShareStationInfo::set_operator_(const char* value,
    size_t size) {
  _has_bits_[0] |= 0x00000010u;
  operator__.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:valhalla.TripLeg.BikeShareStationInfo.operator)
}
inline std::string* TripLeg_BikeShareStationInfo::_internal_mutable_operator_() {
  _has_bits_[0] |= 0x00000010u;
  return operator__.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
}
inline std::string* TripLeg_BikeShareStationInfo::release_operator_() {
  // @@protoc_insertion_point(field_release:valhalla.TripLeg.BikeShareStationInfo.operator)
  if (!_internal_has_operator_()) {
    return nullptr;
  }
  _has_bits_[0] &= ~0x00000010u;
  return operator__.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline void TripLeg_BikeShareStationInfo::set_allocated_operator_(std::string* operator_) {
  ...
  operator__.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), operator_,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:valhalla.TripLeg.BikeShareStationInfo.operator)
}

// optional float rent_cost = 6;
inline bool TripLeg_BikeShareStationInfo::_internal_has_rent_cost() const {
  bool value = (_has_bits_[0] & 0x00000020u) != 0;
  return value;
}
inline bool TripLeg_BikeShareStationInfo::has_rent_cost() const {
  return _internal_has_rent_cost();
}
inline void TripLeg_BikeShareStationInfo::clear_rent_cost() {
  rent_cost_ = 0;
  _has_bits_[0] &= ~0x00000020u;
}
inline float TripLeg_BikeShareStationInfo::_internal_rent_cost() const {
  return rent_cost_;
}
inline float TripLeg_BikeShareStationInfo::rent_cost() const {
  // @@protoc_insertion_point(field_get:valhalla.TripLeg.BikeShareStationInfo.rent_cost)
  return _internal_rent_cost();
}
inline void TripLeg_BikeShareStationInfo::_internal_set_rent_cost(float value) {
  _has_bits_[0] |= 0x00000020u;
  rent_cost_ = value;
}
inline void TripLeg_BikeShareStationInfo::set_rent_cost(float value) {
  _internal_set_rent_cost(value);
  // @@protoc_insertion_point(field_set:valhalla.TripLeg.BikeShareStationInfo.rent_cost)
}

// optional float return_cost = 7;
inline bool TripLeg_BikeShareStationInfo::_internal_has_return_cost() const {
  bool value = (_has_bits_[0] & 0x00000040u) != 0;
  return value;
}
inline bool TripLeg_BikeShareStationInfo::has_return_cost() const {
  return _internal_has_return_cost();
}
inline void TripLeg_BikeShareStationInfo::clear_return_cost() {
  return_cost_ = 0;
  _has_bits_[0] &= ~0x00000040u;
}
inline float TripLeg_BikeShareStationInfo::_internal_return_cost() const {
  return return_cost_;
}
inline float TripLeg_BikeShareStationInfo::return_cost() const {
  // @@protoc_insertion_point(field_get:valhalla.TripLeg.BikeShareStationInfo.return_cost)
  return _internal_return_cost();
}
inline void TripLeg_BikeShareStationInfo::_internal_set_return_cost(float value) {
  _has_bits_[0] |= 0x00000040u;
  return_cost_ = value;
}
inline void TripLeg_BikeShareStationInfo::set_return_cost(float value) {
  _internal_set_return_cost(value);
  // @@protoc_insertion_point(field_set:valhalla.TripLeg.BikeShareStationInfo.return_cost)
}
...
inline void TripLeg_LaneConnectivity::_internal_set_from_lanes(const std::string& value) {
  _has_bits_[0] |= 0x00000001u;
  from_lanes_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
...
inline void TripLeg_LaneConnectivity::set_from_lanes(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _has_bits_[0] |= 0x00000001u;
  from_lanes_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:valhalla.TripLeg.LaneConnectivity.from_lanes)
}
inline void TripLeg_LaneConnectivity::set_from_lanes(const char* value,
    size_t size) {
  _has_bits_[0] |= 0x00000001u;
  from_lanes_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
...
inline std::string* TripLeg_LaneConnectivity::_internal_mutable_from_lanes() {
  _has_bits_[0] |= 0x00000001u;
  return from_lanes_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
}
inline std::string* TripLeg_LaneConnectivity::release_from_lanes() {
  ...
  _has_bits_[0] &= ~0x00000001u;
  return from_lanes_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
...
inline void TripLeg_LaneConnectivity::_internal_set_to_lanes(const std::string& value) {
  _has_bits_[0] |= 0x00000002u;
  to_lanes_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
...
inline void TripLeg_LaneConnectivity::set_to_lanes(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _has_bits_[0] |= 0x00000002u;
  to_lanes_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:valhalla.TripLeg.LaneConnectivity.to_lanes)
}
inline void TripLeg_LaneConnectivity::set_to_lanes(const char* value,
    size_t size) {
  _has_bits_[0] |= 0x00000002u;
  to_lanes_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
...
inline std::string* TripLeg_LaneConnectivity::_internal_mutable_to_lanes() {
  _has_bits_[0] |= 0x00000002u;
  return to_lanes_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
}
inline std::string* TripLeg_LaneConnectivity::release_to_lanes() {
  ...
  _has_bits_[0] &= ~0x00000002u;
  return to_lanes_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
...
// optional bool drive_on_right = 17 [default = true];
inline bool TripLeg_Edge::_internal_has_drive_on_right() const {
  bool value = (_has_bits_[1] & 0x00004000u) != 0;
  return value;
}
inline bool TripLeg_Edge::has_drive_on_right() const {
  return _internal_has_drive_on_right();
}
inline void TripLeg_Edge::clear_drive_on_right() {
  drive_on_right_ = true;
  _has_bits_[1] &= ~0x00004000u;
}
inline bool TripLeg_Edge::_internal_drive_on_right() const {
  return drive_on_right_;
}
inline bool TripLeg_Edge::drive_on_right() const {
  // @@protoc_insertion_point(field_get:valhalla.TripLeg.Edge.drive_on_right)
  return _internal_drive_on_right();
}
inline void TripLeg_Edge::_internal_set_drive_on_right(bool value) {
  _has_bits_[1] |= 0x00004000u;
  drive_on_right_ = value;
}
inline void TripLeg_Edge::set_drive_on_right(bool value) {
  _internal_set_drive_on_right(value);
  // @@protoc_insertion_point(field_set:valhalla.TripLeg.Edge.drive_on_right)
}
...
inline const ::valhalla::TripLeg_Sign& TripLeg_Edge::_internal_sign() const {
  const ::valhalla::TripLeg_Sign* p = sign_;
  return p != nullptr ? *p : reinterpret_cast<const ::valhalla::TripLeg_Sign&>(
      ::valhalla::_TripLeg_Sign_default_instance_);
}
...
inline ::valhalla::TripLeg_Sign* TripLeg_Edge::unsafe_arena_release_sign() {
...
inline ::valhalla::TripLeg_Sign* TripLeg_Edge::_internal_mutable_sign() {
  _has_bits_[0] |= 0x00000001u;
  if (sign_ == nullptr) {
    auto* p = CreateMaybeMessage<::valhalla::TripLeg_Sign>(GetArena());
    sign_ = p;
  }
  return sign_;
}
...
inline ::valhalla::TripLeg_TravelMode TripLeg_Edge::_internal_travel_mode() const {
...
inline void TripLeg_Edge::_internal_set_travel_mode(::valhalla::TripLeg_TravelMode value) {
...
inline ::valhalla::TripLeg_VehicleType TripLeg_Edge::_internal_vehicle_type() const {
...
inline void TripLeg_Edge::_internal_set_vehicle_type(::valhalla::TripLeg_VehicleType value) {
...
inline ::valhalla::TripLeg_PedestrianType TripLeg_Edge::_internal_pedestrian_type() const {
...
inline void TripLeg_Edge::_internal_set_pedestrian_type(::valhalla::TripLeg_PedestrianType value) {
...
inline ::valhalla::TripLeg_BicycleType TripLeg_Edge::_internal_bicycle_type() const {
...
inline void TripLeg_Edge::_internal_set_bicycle_type(::valhalla::TripLeg_BicycleType value) {
...
inline ::valhalla::TripLeg_TransitType TripLeg_Edge::_internal_transit_type() const {
...
inline void TripLeg_Edge::_internal_set_transit_type(::valhalla::TripLeg_TransitType value) {
...
inline bool TripLeg_Edge::_internal_has_transit_route_info() const {
  bool value = (_has_bits_[0] & 0x00000002u) != 0;
  PROTOBUF_ASSUME(!value || transit_route_info_ != nullptr);
  return value;
}
...
inline void TripLeg_Edge::clear_transit_route_info() {
  if (transit_route_info_ != nullptr) transit_route_info_->Clear();
  _has_bits_[0] &= ~0x00000002u;
}
inline const ::valhalla::TripLeg_TransitRouteInfo& TripLeg_Edge::_internal_transit_route_info() const {
  const ::valhalla::TripLeg_TransitRouteInfo* p = transit_route_info_;
  return p != nullptr ? *p : reinterpret_cast<const ::valhalla::TripLeg_TransitRouteInfo&>(
      ::valhalla::_TripLeg_TransitRouteInfo_default_instance_);
}
...
inline ::valhalla::TripLeg_TransitRouteInfo* TripLeg_Edge::unsafe_arena_release_transit_route_info() {
...
inline ::valhalla::TripLeg_TransitRouteInfo* TripLeg_Edge::_internal_mutable_transit_route_info() {
  _has_bits_[0] |= 0x00000002u;
  if (transit_route_info_ == nullptr) {
    auto* p = CreateMaybeMessage<::valhalla::TripLeg_TransitRouteInfo>(GetArena());
...
inline void TripLeg_Edge::set_allocated_transit_route_info(::valhalla::TripLeg_TransitRouteInfo* transit_route_info) {
  ...
  if (transit_route_info) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      ::PROTOBUF_NAMESPACE_ID::Arena::GetArena(transit_route_info);
    if (message_arena != submessage_arena) {
...
inline bool TripLeg_Edge::_internal_has_restriction() const {
  bool value = (_has_bits_[0] & 0x00000004u) != 0;
  PROTOBUF_ASSUME(!value || restriction_ != nullptr);
  return value;
}
...
inline void TripLeg_Edge::clear_restriction() {
  if (restriction_ != nullptr) restriction_->Clear();
  _has_bits_[0] &= ~0x00000004u;
}
...
// repeated .valhalla.TaggedName tagged_name = 48;
inline int TripLeg_Edge::_internal_tagged_name_size() const {
  return tagged_name_.size();
}
inline int TripLeg_Edge::tagged_name_size() const {
  return _internal_tagged_name_size();
}
inline ::valhalla::TaggedName* TripLeg_Edge::mutable_tagged_name(int index) {
  // @@protoc_insertion_point(field_mutable:valhalla.TripLeg.Edge.tagged_name)
  return tagged_name_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::valhalla::TaggedName >*
TripLeg_Edge::mutable_tagged_name() {
  // @@protoc_insertion_point(field_mutable_list:valhalla.TripLeg.Edge.tagged_name)
  return &tagged_name_;
}
inline const ::valhalla::TaggedName& TripLeg_Edge::_internal_tagged_name(int index) const {
  return tagged_name_.Get(index);
}
inline const ::valhalla::TaggedName& TripLeg_Edge::tagged_name(int index) const {
  // @@protoc_insertion_point(field_get:valhalla.TripLeg.Edge.tagged_name)
  return _internal_tagged_name(index);
}
inline ::valhalla::TaggedName* TripLeg_Edge::_internal_add_tagged_name() {
  return tagged_name_.Add();
}
inline ::valhalla::TaggedName* TripLeg_Edge::add_tagged_name() {
  // @@protoc_insertion_point(field_add:valhalla.TripLeg.Edge.tagged_name)
  return _internal_add_tagged_name();
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::valhalla::TaggedName >&
TripLeg_Edge::tagged_name() const {
  // @@protoc_insertion_point(field_list:valhalla.TripLeg.Edge.tagged_name)
  return tagged_name_;
}
...
inline void TripLeg_Edge::_internal_set_sac_scale(::valhalla::TripLeg_SacScale value) {
  assert(::valhalla::TripLeg_SacScale_IsValid(value));
  _has_bits_[1] |= 0x00002000u;
  sac_scale_ = value;
}
...
inline bool TripLeg_PathCost::_internal_has_elapsed_cost() const {
  bool value = (_has_bits_[0] & 0x00000001u) != 0;
  PROTOBUF_ASSUME(!value || elapsed_cost_ != nullptr);
  return value;
}
...
inline void TripLeg_PathCost::clear_elapsed_cost() {
  if (elapsed_cost_ != nullptr) elapsed_cost_->Clear();
  _has_bits_[0] &= ~0x00000001u;
}
...
inline bool TripLeg_PathCost::_internal_has_transition_cost() const {
  bool value = (_has_bits_[0] & 0x00000002u) != 0;
  PROTOBUF_ASSUME(!value || transition_cost_ != nullptr);
  return value;
}
...
inline void TripLeg_PathCost::clear_transition_cost() {
  if (transition_cost_ != nullptr) transition_cost_->Clear();
  _has_bits_[0] &= ~0x00000002u;
}
...
inline bool TripLeg_Node::_internal_has_edge() const {
  bool value = (_has_bits_[0] & 0x00000002u) != 0;
  PROTOBUF_ASSUME(!value || edge_ != nullptr);
  return value;
}
...
inline bool TripLeg_Node::_internal_has_transit_platform_info() const {
  bool value = (_has_bits_[0] & 0x00000004u) != 0;
  PROTOBUF_ASSUME(!value || transit_platform_info_ != nullptr);
  return value;
}
...
inline bool TripLeg_Node::_internal_has_transit_station_info() const {
  bool value = (_has_bits_[0] & 0x00000008u) != 0;
  PROTOBUF_ASSUME(!value || transit_station_info_ != nullptr);
  return value;
}
...
inline bool TripLeg_Node::_internal_has_transit_egress_info() const {
  bool value = (_has_bits_[0] & 0x00000010u) != 0;
  PROTOBUF_ASSUME(!value || transit_egress_info_ != nullptr);
  return value;
}
...
inline bool TripLeg_Node::_internal_has_bss_info() const {
  bool value = (_has_bits_[0] & 0x00000040u) != 0;
  PROTOBUF_ASSUME(!value || bss_info_ != nullptr);
  return value;
}
...
inline void TripLeg_Node::clear_bss_info() {
  if (bss_info_ != nullptr) bss_info_->Clear();
  _has_bits_[0] &= ~0x00000040u;
}
inline const ::valhalla::TripLeg_BikeShareStationInfo& TripLeg_Node::_internal_bss_info() const {
  const ::valhalla::TripLeg_BikeShareStationInfo* p = bss_info_;
  return p != nullptr ? *p : reinterpret_cast<const ::valhalla::TripLeg_BikeShareStationInfo&>(
      ::valhalla::_TripLeg_BikeShareStationInfo_default_instance_);
}
inline const ::valhalla::TripLeg_BikeShareStationInfo& TripLeg_Node::bss_info() const {
...
inline ::valhalla::TripLeg_BikeShareStationInfo* TripLeg_Node::release_bss_info() {
  _has_bits_[0] &= ~0x00000040u;
  ::valhalla::TripLeg_BikeShareStationInfo* temp = bss_info_;
  bss_info_ = nullptr;
  if (GetArena() != nullptr) {
    temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
  }
...
inline ::valhalla::TripLeg_BikeShareStationInfo* TripLeg_Node::unsafe_arena_release_bss_info() {
...
inline ::valhalla::TripLeg_BikeShareStationInfo* TripLeg_Node::_internal_mutable_bss_info() {
  _has_bits_[0] |= 0x00000040u;
  if (bss_info_ == nullptr) {
    auto* p = CreateMaybeMessage<::valhalla::TripLeg_BikeShareStationInfo>(GetArena());
    bss_info_ = p;
  }
  return bss_info_;
}
inline ::valhalla::TripLeg_BikeShareStationInfo* TripLeg_Node::mutable_bss_info() {
  // @@protoc_insertion_point(field_mutable:valhalla.TripLeg.Node.bss_info)
  return _internal_mutable_bss_info();
}
inline void TripLeg_Node::set_allocated_bss_info(::valhalla::TripLeg_BikeShareStationInfo* bss_info) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArena();
  if (message_arena == nullptr) {
    delete bss_info_;
  }
  if (bss_info) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      ::PROTOBUF_NAMESPACE_ID::Arena::GetArena(bss_info);
    if (message_arena != submessage_arena) {
...
inline void TripLeg_Admin::_internal_set_country_text(const std::string& value) {
  _has_bits_[0] |= 0x00000002u;
  country_text_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
...
inline void TripLeg_Admin::set_country_text(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _has_bits_[0] |= 0x00000002u;
  country_text_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:valhalla.TripLeg.Admin.country_text)
}
inline void TripLeg_Admin::set_country_text(const char* value,
    size_t size) {
  _has_bits_[0] |= 0x00000002u;
  country_text_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
...
inline std::string* TripLeg_Admin::_internal_mutable_country_text() {
  _has_bits_[0] |= 0x00000002u;
  return country_text_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
}
inline std::string* TripLeg_Admin::release_country_text() {
  ...
  _has_bits_[0] &= ~0x00000002u;
  return country_text_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
...
inline void TripLeg_Admin::_internal_set_state_code(const std::string& value) {
  _has_bits_[0] |= 0x00000004u;
  state_code_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
...
inline void TripLeg_Admin::set_state_code(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _has_bits_[0] |= 0x00000004u;
  state_code_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:valhalla.TripLeg.Admin.state_code)
}
inline void TripLeg_Admin::set_state_code(const char* value,
    size_t size) {
  _has_bits_[0] |= 0x00000004u;
  state_code_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
...
inline std::string* TripLeg_Admin::_internal_mutable_state_code() {
  _has_bits_[0] |= 0x00000004u;
  return state_code_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
}
inline std::string* TripLeg_Admin::release_state_code() {
  ...
  _has_bits_[0] &= ~0x00000004u;
  return state_code_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
...
inline void TripLeg_Admin::_internal_set_state_text(const std::string& value) {
  _has_bits_[0] |= 0x00000008u;
  state_text_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
...
inline void TripLeg_Admin::set_state_text(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _has_bits_[0] |= 0x00000008u;
  state_text_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:valhalla.TripLeg.Admin.state_text)
}
inline void TripLeg_Admin::set_state_text(const char* value,
    size_t size) {
  _has_bits_[0] |= 0x00000008u;
  state_text_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
...
inline std::string* TripLeg_Admin::_internal_mutable_state_text() {
  _has_bits_[0] |= 0x00000008u;
  return state_text_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
}
inline std::string* TripLeg_Admin::release_state_text() {
  ...
  _has_bits_[0] &= ~0x00000008u;
  return state_text_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
...
inline std::string* TripLeg::release_shape() {
  ...
  _has_bits_[0] &= ~0x00000001u;
  return shape_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
...
inline bool TripLeg::_internal_has_shape_attributes() const {
  bool value = (_has_bits_[0] & 0x00000004u) != 0;
  PROTOBUF_ASSUME(!value || shape_attributes_ != nullptr);
  return value;
}
...
inline void TripLeg::clear_shape_attributes() {
  if (shape_attributes_ != nullptr) shape_attributes_->Clear();
  _has_bits_[0] &= ~0x00000004u;
}
...
template <> struct is_proto_enum< ::valhalla::TripLeg_TravelMode> : ::std::true_type {};
template <> struct is_proto_enum< ::valhalla::TripLeg_VehicleType> : ::std::true_type {};
template <> struct is_proto_enum< ::valhalla::TripLeg_PedestrianType> : ::std::true_type {};
template <> struct is_proto_enum< ::valhalla::TripLeg_BicycleType> : ::std::true_type {};
template <> struct is_proto_enum< ::valhalla::TripLeg_TransitType> : ::std::true_type {};
