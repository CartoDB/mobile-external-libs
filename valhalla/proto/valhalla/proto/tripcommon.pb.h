...
extern TaggedNameDefaultTypeInternal _TaggedName_default_instance_;
...
template<> ::valhalla::TaggedName* Arena::CreateMaybeMessage<::valhalla::TaggedName>(Arena*);
...
enum TaggedName_Type : int {
  TaggedName_Type_kTunnel = 1,
  TaggedName_Type_kBridge = 2
};
bool TaggedName_Type_IsValid(int value);
constexpr TaggedName_Type TaggedName_Type_Type_MIN = TaggedName_Type_kTunnel;
constexpr TaggedName_Type TaggedName_Type_Type_MAX = TaggedName_Type_kBridge;
constexpr int TaggedName_Type_Type_ARRAYSIZE = TaggedName_Type_Type_MAX + 1;

const std::string& TaggedName_Type_Name(TaggedName_Type value);
template<typename T>
inline const std::string& TaggedName_Type_Name(T enum_t_value) {
  static_assert(::std::is_same<T, TaggedName_Type>::value ||
    ::std::is_integral<T>::value,
    "Incorrect type passed to function TaggedName_Type_Name.");
  return TaggedName_Type_Name(static_cast<TaggedName_Type>(enum_t_value));
}
...
class Location PROTOBUF_FINAL :
 ...
 public:
  ...
  private:
  bool _internal_has_shape_index() const;
  public:
  void clear_shape_index();
  ::PROTOBUF_NAMESPACE_ID::uint32 shape_index() const;
  void set_shape_index(::PROTOBUF_NAMESPACE_ID::uint32 value);
  private:
  ::PROTOBUF_NAMESPACE_ID::uint32 _internal_shape_index() const;
  void _internal_set_shape_index(::PROTOBUF_NAMESPACE_ID::uint32 value);
  public:
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::uint32 shape_index_;
...
class TaggedName PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::MessageLite /* @@protoc_insertion_point(class_definition:valhalla.TaggedName) */ {
 public:
  inline TaggedName() : TaggedName(nullptr) {}
  virtual ~TaggedName();
  explicit constexpr TaggedName(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  TaggedName(const TaggedName& from);
  TaggedName(TaggedName&& from) noexcept
    : TaggedName() {
    *this = ::std::move(from);
  }

  inline TaggedName& operator=(const TaggedName& from) {
    CopyFrom(from);
    return *this;
  }
  inline TaggedName& operator=(TaggedName&& from) noexcept {
    if (GetArena() == from.GetArena()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  static const TaggedName& default_instance() {
    return *internal_default_instance();
  }
  static inline const TaggedName* internal_default_instance() {
    return reinterpret_cast<const TaggedName*>(
               &_TaggedName_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    10;

  friend void swap(TaggedName& a, TaggedName& b) {
    a.Swap(&b);
  }
  inline void Swap(TaggedName* other) {
    if (other == this) return;
    if (GetArena() == other->GetArena()) {
      InternalSwap(other);
    } else {
  ...
  void UnsafeArenaSwap(TaggedName* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetArena() == other->GetArena());
    InternalSwap(other);
  }
  ...
  inline TaggedName* New() const final {
    return CreateMaybeMessage<TaggedName>(nullptr);
  }

  TaggedName* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<TaggedName>(arena);
  }
  void CheckTypeAndMergeFrom(const ::PROTOBUF_NAMESPACE_ID::MessageLite& from)
    final;
  void CopyFrom(const TaggedName& from);
  void MergeFrom(const TaggedName& from);
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  bool IsInitialized() const final;
  ...
  inline void SharedDtor();
  void SetCachedSize(int size) const;
  void InternalSwap(TaggedName* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "valhalla.TaggedName";
  }
  protected:
  explicit TaggedName(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  public:
  ...
  typedef TaggedName_Type Type;
  static constexpr Type kTunnel =
    TaggedName_Type_kTunnel;
  static constexpr Type kBridge =
    TaggedName_Type_kBridge;
  static inline bool Type_IsValid(int value) {
    return TaggedName_Type_IsValid(value);
  }
  static constexpr Type Type_MIN =
    TaggedName_Type_Type_MIN;
  static constexpr Type Type_MAX =
    TaggedName_Type_Type_MAX;
  static constexpr int Type_ARRAYSIZE =
    TaggedName_Type_Type_ARRAYSIZE;
  template<typename T>
  static inline const std::string& Type_Name(T enum_t_value) {
    static_assert(::std::is_same<T, Type>::value ||
      ::std::is_integral<T>::value,
      "Incorrect type passed to function Type_Name.");
    return TaggedName_Type_Name(enum_t_value);
  }
  static inline bool Type_Parse(::PROTOBUF_NAMESPACE_ID::ConstStringParam name,
      Type* value) {
    return TaggedName_Type_Parse(name, value);
  }
  ...
  public:
  void clear_type();
  ::valhalla::TaggedName_Type type() const;
  void set_type(::valhalla::TaggedName_Type value);
  private:
  ::valhalla::TaggedName_Type _internal_type() const;
  void _internal_set_type(::valhalla::TaggedName_Type value);
  public:

  // @@protoc_insertion_point(class_scope:valhalla.TaggedName)
 private:
  class _Internal;
...
inline void Location::_internal_set_postal_code(const std::string& value) {
  _has_bits_[0] |= 0x00000010u;
  postal_code_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
...
inline void Location::set_postal_code(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _has_bits_[0] |= 0x00000010u;
  postal_code_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:valhalla.Location.postal_code)
}
inline void Location::set_postal_code(const char* value,
    size_t size) {
  _has_bits_[0] |= 0x00000010u;
  postal_code_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
...
inline std::string* Location::_internal_mutable_postal_code() {
  _has_bits_[0] |= 0x00000010u;
  return postal_code_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
}
inline std::string* Location::release_postal_code() {
  ...
  _has_bits_[0] &= ~0x00000010u;
  return postal_code_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
...
// optional uint32 shape_index = 31;
inline bool Location::_internal_has_shape_index() const {
  bool value = (_has_bits_[0] & 0x08000000u) != 0;
  return value;
}
inline bool Location::has_shape_index() const {
  return _internal_has_shape_index();
}
inline void Location::clear_shape_index() {
  shape_index_ = 0u;
  _has_bits_[0] &= ~0x08000000u;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 Location::_internal_shape_index() const {
  return shape_index_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 Location::shape_index() const {
  // @@protoc_insertion_point(field_get:valhalla.Location.shape_index)
  return _internal_shape_index();
}
inline void Location::_internal_set_shape_index(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  _has_bits_[0] |= 0x08000000u;
  shape_index_ = value;
}
inline void Location::set_shape_index(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  _internal_set_shape_index(value);
  // @@protoc_insertion_point(field_set:valhalla.Location.shape_index)
}
...
inline void TransitPlatformInfo::_internal_set_arrival_date_time(const std::string& value) {
  _has_bits_[0] |= 0x00000004u;
  arrival_date_time_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
inline void TransitPlatformInfo::set_arrival_date_time(std::string&& value) {
  _has_bits_[0] |= 0x00000004u;
  arrival_date_time_.Set(
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::move(value), GetArena());
...
inline void TransitPlatformInfo::set_arrival_date_time(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _has_bits_[0] |= 0x00000004u;
  arrival_date_time_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:valhalla.TransitPlatformInfo.arrival_date_time)
}
inline void TransitPlatformInfo::set_arrival_date_time(const char* value,
    size_t size) {
  _has_bits_[0] |= 0x00000004u;
  arrival_date_time_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
...
inline std::string* TransitPlatformInfo::_internal_mutable_arrival_date_time() {
  _has_bits_[0] |= 0x00000004u;
  return arrival_date_time_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
}
inline std::string* TransitPlatformInfo::release_arrival_date_time() {
  ...
  _has_bits_[0] &= ~0x00000004u;
  return arrival_date_time_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
...
inline void TransitPlatformInfo::_internal_set_departure_date_time(const std::string& value) {
  _has_bits_[0] |= 0x00000008u;
  departure_date_time_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
inline void TransitPlatformInfo::set_departure_date_time(std::string&& value) {
  _has_bits_[0] |= 0x00000008u;
  departure_date_time_.Set(
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::move(value), GetArena());
...
inline void TransitPlatformInfo::set_departure_date_time(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _has_bits_[0] |= 0x00000008u;
  departure_date_time_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:valhalla.TransitPlatformInfo.departure_date_time)
}
inline void TransitPlatformInfo::set_departure_date_time(const char* value,
    size_t size) {
  _has_bits_[0] |= 0x00000008u;
  departure_date_time_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
...
inline std::string* TransitPlatformInfo::_internal_mutable_departure_date_time() {
  _has_bits_[0] |= 0x00000008u;
  return departure_date_time_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
}
inline std::string* TransitPlatformInfo::release_departure_date_time() {
  ...
  _has_bits_[0] &= ~0x00000008u;
  return departure_date_time_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
...
inline void TransitPlatformInfo::_internal_set_station_onestop_id(const std::string& value) {
  _has_bits_[0] |= 0x00000010u;
  station_onestop_id_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
inline void TransitPlatformInfo::set_station_onestop_id(std::string&& value) {
  _has_bits_[0] |= 0x00000010u;
  station_onestop_id_.Set(
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::move(value), GetArena());
...
inline void TransitPlatformInfo::set_station_onestop_id(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _has_bits_[0] |= 0x00000010u;
  station_onestop_id_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:valhalla.TransitPlatformInfo.station_onestop_id)
}
inline void TransitPlatformInfo::set_station_onestop_id(const char* value,
    size_t size) {
  _has_bits_[0] |= 0x00000010u;
  station_onestop_id_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
...
inline std::string* TransitPlatformInfo::_internal_mutable_station_onestop_id() {
  _has_bits_[0] |= 0x00000010u;
  return station_onestop_id_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
}
inline std::string* TransitPlatformInfo::release_station_onestop_id() {
  ...
  _has_bits_[0] &= ~0x00000010u;
  return station_onestop_id_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
...
inline void TransitPlatformInfo::_internal_set_station_name(const std::string& value) {
  _has_bits_[0] |= 0x00000020u;
  station_name_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
...
inline void TransitPlatformInfo::set_station_name(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _has_bits_[0] |= 0x00000020u;
  station_name_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:valhalla.TransitPlatformInfo.station_name)
}
inline void TransitPlatformInfo::set_station_name(const char* value,
    size_t size) {
  _has_bits_[0] |= 0x00000020u;
  station_name_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
...
inline std::string* TransitPlatformInfo::_internal_mutable_station_name() {
  _has_bits_[0] |= 0x00000020u;
  return station_name_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
}
inline std::string* TransitPlatformInfo::release_station_name() {
  ...
  _has_bits_[0] &= ~0x00000020u;
  return station_name_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
...
// optional string value = 1;
inline bool TaggedName::_internal_has_value() const {
  bool value = (_has_bits_[0] & 0x00000001u) != 0;
  return value;
}
inline bool TaggedName::has_value() const {
  return _internal_has_value();
}
inline void TaggedName::clear_value() {
  value_.ClearToEmpty();
  _has_bits_[0] &= ~0x00000001u;
}
inline const std::string& TaggedName::value() const {
  // @@protoc_insertion_point(field_get:valhalla.TaggedName.value)
  return _internal_value();
}
inline void TaggedName::set_value(const std::string& value) {
  _internal_set_value(value);
  // @@protoc_insertion_point(field_set:valhalla.TaggedName.value)
}
inline std::string* TaggedName::mutable_value() {
  // @@protoc_insertion_point(field_mutable:valhalla.TaggedName.value)
  return _internal_mutable_value();
}
inline const std::string& TaggedName::_internal_value() const {
  return value_.Get();
}
inline void TaggedName::_internal_set_value(const std::string& value) {
  _has_bits_[0] |= 0x00000001u;
  value_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
inline void TaggedName::set_value(std::string&& value) {
  _has_bits_[0] |= 0x00000001u;
  value_.Set(
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:valhalla.TaggedName.value)
}
inline void TaggedName::set_value(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _has_bits_[0] |= 0x00000001u;
  value_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:valhalla.TaggedName.value)
}
inline void TaggedName::set_value(const char* value,
    size_t size) {
  _has_bits_[0] |= 0x00000001u;
  value_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:valhalla.TaggedName.value)
}
inline std::string* TaggedName::_internal_mutable_value() {
  _has_bits_[0] |= 0x00000001u;
  return value_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
}
inline std::string* TaggedName::release_value() {
  // @@protoc_insertion_point(field_release:valhalla.TaggedName.value)
  if (!_internal_has_value()) {
    return nullptr;
  }
  _has_bits_[0] &= ~0x00000001u;
...
inline void TaggedName::set_allocated_value(std::string* value) {
  if (value != nullptr) {
    _has_bits_[0] |= 0x00000001u;
  } else {
    _has_bits_[0] &= ~0x00000001u;
  ...
  value_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:valhalla.TaggedName.value)
}

// optional .valhalla.TaggedName.Type type = 2;
inline bool TaggedName::_internal_has_type() const {
  bool value = (_has_bits_[0] & 0x00000002u) != 0;
  return value;
}
inline bool TaggedName::has_type() const {
  return _internal_has_type();
}
inline void TaggedName::clear_type() {
  type_ = 1;
  _has_bits_[0] &= ~0x00000002u;
}
inline ::valhalla::TaggedName_Type TaggedName::_internal_type() const {
  return static_cast< ::valhalla::TaggedName_Type >(type_);
}
inline ::valhalla::TaggedName_Type TaggedName::type() const {
  // @@protoc_insertion_point(field_get:valhalla.TaggedName.type)
  return _internal_type();
}
inline void TaggedName::_internal_set_type(::valhalla::TaggedName_Type value) {
  assert(::valhalla::TaggedName_Type_IsValid(value));
  _has_bits_[0] |= 0x00000002u;
  type_ = value;
}
inline void TaggedName::set_type(::valhalla::TaggedName_Type value) {
  _internal_set_type(value);
  // @@protoc_insertion_point(field_set:valhalla.TaggedName.type)
}
...
template <> struct is_proto_enum< ::valhalla::TaggedName_Type> : ::std::true_type {};
