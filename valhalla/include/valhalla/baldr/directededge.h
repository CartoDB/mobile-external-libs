...
public:
  ...
  bool name_consistency(const uint32_t idx) const {
    // CARTOHACK
    return static_cast<uint32_t>(name_consistency_) & static_cast<uint32_t>(1 << idx);
  }
  ...
  bool edge_to_left(const uint32_t localidx) const {
    // CARTOHACK
    return static_cast<uint32_t>(edge_to_left_) & static_cast<uint32_t>(1 << localidx);
  }
  ...
  bool edge_to_right(const uint32_t localidx) const {
    // CARTOHACK
    return static_cast<uint32_t>(stopimpact_.s.edge_to_right) & static_cast<uint32_t>(1 << localidx);
  }
