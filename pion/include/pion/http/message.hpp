...
public:
        ...
        : public asio::error_category
    {
        ...
        virtual inline const char *name() const ASIO_ERROR_CATEGORY_NOEXCEPT { return "receive_error_t"; }
    ...
    inline content_length_t get_content_length(void) const { return m_content_length; }
    ...
    inline void set_content_length(content_length_t n) { m_content_length = n; }
    ...
    inline void update_content_length_using_header(void) {
        ...
        if (i == m_headers.end()) {
            ...
            m_content_length = boost::lexical_cast<content_length_t>(trimmed_length);
        }
    }
    ...
    inline char *create_content_buffer(void) {
		m_content_buf.resize(static_cast<std::size_t>(m_content_length));
     ...
     *
     * @return content_length_t number of bytes read from the connection
     */
    content_length_t receive(tcp::connection& tcp_conn,
                        asio::error_code& ec,
                        parser& http_parser);
    ...
    content_length_t receive(tcp::connection& tcp_conn,
                        asio::error_code& ec,
                        bool headers_only = false,
                        content_length_t max_content_length = static_cast<content_length_t>(-1));
     ...
     * @return content_length_t number of bytes read from the connection
     */
    content_length_t read(std::istream& in,
                     asio::error_code& ec,
                     parser& http_parser);
...
private:
    ...
    content_length_t                m_content_length;
